...
CREATE TABLE `app_keywords` (
  ...
  `app_keyword_type` varchar(255) DEFAULT 'School',
  `language_id` int(11) unsigned DEFAULT NULL,
  `app_name` varchar(60) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `institution_id` int(11) unsigned DEFAULT NULL,
  `content` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT '',
...
-- Dump completed on 2026-04-30 16:36:17
