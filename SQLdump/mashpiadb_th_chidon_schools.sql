...
CREATE TABLE `th_chidon_schools` (
  ...
  `bus` tinyint(1) unsigned DEFAULT 0,
  `food` tinyint(1) unsigned DEFAULT 0,
  `payment_profile_id` int(10) unsigned DEFAULT NULL,
  `airport` varchar(45) DEFAULT NULL,
  `option` varchar(45) DEFAULT NULL,
  `goggles_rent` int(10) unsigned DEFAULT NULL,
  `goggles_buy` int(10) unsigned DEFAULT NULL,
