...
CREATE TABLE `raffles_monthly` (
  `raffles_monthly_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `raffle_id` int(10) unsigned DEFAULT NULL,
  `prize_id` int(10) unsigned DEFAULT NULL,
  `school_id` int(10) unsigned DEFAULT NULL,
  PRIMARY KEY (`raffles_monthly_id`)
) ENGINE=InnoDB AUTO_INCREMENT=4910 DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;
...
-- Dump completed on 2026-04-30 16:33:37
