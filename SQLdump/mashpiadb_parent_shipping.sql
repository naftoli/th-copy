...
--
-- Table structure for table `parent_shipping`
--

DROP TABLE IF EXISTS `parent_shipping`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `parent_shipping` (
  `parent_shipping_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`parent_shipping_id`)
