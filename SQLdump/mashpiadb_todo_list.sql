...
CREATE TABLE `todo_list` (
  ...
  `recip` enum('school','class','team','user','end_user') NOT NULL,
  `school_id` int(10) unsigned DEFAULT NULL,
  `recip_id` int(10) unsigned DEFAULT NULL,
  `todo_text` varchar(255) NOT NULL,
  `todo_priority` enum('Urgent','High','Medium','Low') NOT NULL DEFAULT 'Medium',
  ...
  `visibility` enum('all','none') NOT NULL DEFAULT 'all',
...
-- Dump completed on 2026-04-30 16:31:40
