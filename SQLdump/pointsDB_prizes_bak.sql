...
--
-- Table structure for table `prizes_bak`
--

DROP TABLE IF EXISTS `prizes_bak`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `prizes_bak` (
...
) ENGINE=InnoDB AUTO_INCREMENT=164765 DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
-- Dump completed on 2026-04-30 16:36:13
