...
CREATE TABLE `payments` (
  ...
  `email` varchar(85) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
  `amount` decimal(7,2) unsigned NOT NULL,
  `response` varchar(255) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
  `phone` varchar(60) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL,
...
-- Dump completed on 2026-04-30 16:30:47
