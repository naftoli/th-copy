...
CREATE TABLE `tehillim_backups` (
  ...
  `mark_description` varchar(75) DEFAULT NULL,
  ...
  KEY `GRID` (`grid_id`),
  KEY `sm_date` (`sm_date`),
  KEY `idx_backup_lookup` (`sm_date`,`grid_id`,`user_id`)
) ENGINE=InnoDB AUTO_INCREMENT=870680 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
-- Dump completed on 2026-04-30 16:33:14
