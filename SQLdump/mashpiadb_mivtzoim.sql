...
--
-- Table structure for table `mivtzoim`
--

DROP TABLE IF EXISTS `mivtzoim`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `mivtzoim` (
  `mivtzoim_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
-- Dump completed on 2026-04-30 16:30:53
