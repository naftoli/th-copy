...
CREATE TABLE `school_task_exceptions` (
  ...
  KEY `idx_ste_lookup` (`school_id`,`date_task_id`)
) ENGINE=InnoDB AUTO_INCREMENT=6954372 DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;
...
-- Dump completed on 2026-04-30 16:34:20
