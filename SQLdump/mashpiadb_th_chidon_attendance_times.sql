...
CREATE TABLE `th_chidon_attendance_times` (
  ...
  `day_of_week` enum('thursday','friday','motzei shabbos','sunday') DEFAULT NULL,
  `att_time` datetime NOT NULL,
  `att_type` enum('walk','chap','bunk') NOT NULL,
  `att_type_number` varchar(6) NOT NULL,
...
) ENGINE=InnoDB AUTO_INCREMENT=7207 DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;
...
-- Dump completed on 2026-04-30 16:35:52
