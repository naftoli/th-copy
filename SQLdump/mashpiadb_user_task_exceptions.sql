...
CREATE TABLE `user_task_exceptions` (
  ...
  KEY `idx_ute_lookup` (`user_id`,`date_task_id`)
) ENGINE=InnoDB AUTO_INCREMENT=104116857 DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;
...
-- Dump completed on 2026-04-30 16:35:11
