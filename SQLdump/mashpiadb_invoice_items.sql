...
CREATE TABLE `invoice_items` (
  ...
  `item_ref_type` enum('school_packages','school_package_fees','payment','charge','credit','note') DEFAULT NULL,
  `item_ref_id` int(10) unsigned DEFAULT NULL,
  `item_description` varchar(512) NOT NULL,
  `item_cc_ref` varchar(50) NOT NULL,
...
-- Dump completed on 2026-04-30 16:31:00
