...
--
-- Table structure for table `hachayols`
--

DROP TABLE IF EXISTS `hachayols`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `hachayols` (
  `hachayol_id` int(11) NOT NULL AUTO_INCREMENT,
  `year` int(11) DEFAULT NULL,
  `print_number` int(11) DEFAULT NULL,
...
-- Dump completed on 2026-04-30 16:35:37
