...
CREATE TABLE `admins` (
  ...
  `authorize_customer_profile_id` varchar(30) DEFAULT NULL,
  `chabad_org_shliach_id` int(10) unsigned DEFAULT NULL,
  `google_id` char(100) DEFAULT NULL,
  `beta` tinyint(1) NOT NULL DEFAULT 0,
  `show_chidon_refund` tinyint(1) unsigned NOT NULL DEFAULT 0,
  `already_refunded` tinyint(1) unsigned NOT NULL DEFAULT 0,
  `confirmed_chidon_5781` tinyint(3) unsigned DEFAULT 0,
  `confirmed_prizes` tinyint(3) unsigned DEFAULT 0,
  `confirmed_sweaters` tinyint(3) unsigned DEFAULT 0,
  `confirmed_chidon_trans_id` varchar(40) DEFAULT NULL,
  `chidon_confirmed_5782` tinyint(3) unsigned DEFAULT 0,
  `chidon_shipping_paid` int(10) unsigned DEFAULT NULL,
  `updated_address` tinyint(3) unsigned NOT NULL DEFAULT 0,
...
) ENGINE=InnoDB AUTO_INCREMENT=201996 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
-- Dump completed on 2026-04-30 16:31:55
