...
CREATE TABLE `th_20_reg` (
  ...
  `camp` varchar(100) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
  `number_staff` int(10) unsigned NOT NULL,
  `number_campers` int(10) unsigned NOT NULL,
  `ccauth` varchar(255) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
...
-- Dump completed on 2026-04-30 16:31:39
