...
--
-- Table structure for table `deleted_prizes`
--

DROP TABLE IF EXISTS `deleted_prizes`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `deleted_prizes` (
  `deleted_prize_id` int(11) NOT NULL AUTO_INCREMENT,
  `admin_id` int(10) unsigned NOT NULL,
  `school_id` int(10) unsigned NOT NULL,
  `prize_id` int(10) unsigned NOT NULL,
  `prize_name` varchar(45) NOT NULL,
  `prize_points` int(10) unsigned NOT NULL,
  PRIMARY KEY (`deleted_prize_id`)
...
-- Dump completed on 2026-04-30 16:34:30
