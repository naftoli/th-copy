...
/**
 * exports another version of ChabadOrgButton that loads the old chabad.org button based on the javascript api
 * 
 * We hope to eliminate this file once they provide us a link to open ourselves so we can control the button styles
 */
...
export class ChabadOrgButton extends Component {
  ...
  render() {
    ...
    const className = classnames( 'ChabadOrgLegacy', {
      'disabled': disabled
    });
