...
<? echo "2) SCHOOL ID:$school_id<br />"; ?>

<? if ($school_id < 1) : ?>

			<form name="date_tasks_report" id="date_tasks_report" action="summer_report_new.php" method="post" accept-charset="UTF-8">
