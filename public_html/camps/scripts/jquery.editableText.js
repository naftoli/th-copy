...
(function(){
    ...
    $.fn.editableText = function(options){
        ...
        return this.each(function(){
            ...
            var editEl = buttons.find('.edit').click(function(e){
				e.preventDefault();
				startEditing();
			});				
							
			buttons.find('.save').click(function(e){
				e.preventDefault();
				stopEditing();
				editable.trigger(options.changeEvent);
			});				
			buttons.find('.cancel').click(function(e){
				e.preventDefault();
				stopEditing();
			...
			function startEditing(){
				...
				editable.addClass('editableLive');
			}
			/**
			...
			function stopEditing(){
				...
				editable.removeClass('editableLive');
			}
        });
    }
})();