...
$myshliach = new MyShliachShipLabels($previous);
	...
	<div class="no-print">
        <h1>Medals Labels Report</h1>        
            <div>
                ...
                <? if ( $previous ) { ?> 
                Click <a href='myShliachShipLabels.php'>here</a> to show next report dates.<br /><br />
                <? } else { ?> 
                Click <a href='myShliachShipLabels.php?go=back'>here</a> to show previous report dates.<br /><br />
                <? } ?>
            </div>
