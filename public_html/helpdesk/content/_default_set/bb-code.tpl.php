...
<div class="bbButtons">
  ...
  <div class="mobilebreakpoint">
   ...
   <button class="btn btn-info btn-sm" type="button" onclick="mswBBTags('vimeo','comments')"><i class="fa fa-play fa-fw"></i></button>
   <button class="btn btn-success btn-sm" type="button" onclick="window.open('index.php?bbcode=show','_blank')"><i class="fa fa-question fa-fw"></i></button>
  </div>
</div>