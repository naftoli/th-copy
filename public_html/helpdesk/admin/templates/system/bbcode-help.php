      ...
      <div class="panel-body text_height_25">
        ...
        <div>
          ...
          <div class="alert alert-info margin_top_10">
            <ul class="bbUl"><li><?php echo $msg_bbcode20; ?> 1</li><li><?php echo $msg_bbcode20; ?> 2</li><li><?php echo $msg_bbcode20; ?> 3</li></ul>
          </div>
        </div>
        ...
        <div>
          ...
          <div class="alert alert-info margin_top_10">
            <ul class="bbUlNumbered"><li><?php echo $msg_bbcode21; ?> 1</li><li><?php echo $msg_bbcode21; ?> 2</li><li><?php echo $msg_bbcode21; ?> 3</li></ul>
          </div>
        </div>
        ...
        <div>
          ...
          <div class="alert alert-info margin_top_10">
            <ul class="bbUlAlpha"><li><?php echo $msg_bbcode22; ?> 1</li><li><?php echo $msg_bbcode22; ?> 2</li><li><?php echo $msg_bbcode22; ?> 3</li></ul>
          </div>
        </div>

        <div>
          <b>[list=ua]</b><br><b>&nbsp;[*]</b> <?php echo $msg_bbcode22; ?> 1 <b>[/*]<br>&nbsp;[*]</b> <?php echo $msg_bbcode22; ?> 2 <b>[/*]<br>&nbsp;[*]</b> <?php echo $msg_bbcode22; ?> 3 <b>[/*]<br>[/list]</b>
          <div class="alert alert-info margin_top_10">
            <ul class="bbUlUpperAlpha"><li><?php echo $msg_bbcode22; ?> 1</li><li><?php echo $msg_bbcode22; ?> 2</li><li><?php echo $msg_bbcode22; ?> 3</li></ul>
          </div>
        </div>
