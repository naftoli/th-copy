...
if (isset($_POST['action'])) {
    ...
    if ($action == "produce_report") {
        ...
        // pesach 5776
		$dates['start'] = array(2457501, 2457508);
		$dates['end'] = array(2457507, 2457514);
        ...
        $sql = "SELECT report_name FROM reports 
            ...
            AND visibility != 'none' 
            and start_date >= 2457116  
            and end_date <= 2457129  
            ORDER BY start_date"; 
        //echo $sql;   
        $query = mysql_query($sql);
    ...
    <body>
        ...
        <div class="body left marking_missions">
            ...
            <div class="infobox noprint">
                Pesach missions include 2 weeks worth of missions.
            </div>
            
            <form name="date_tasks_report" id="date_tasks_report" action="date_tasks_print_pesach.php" method="post" accept-charset="UTF-8">
