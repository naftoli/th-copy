            ...
            <div class="marking module dontsplit">            
                        ...
                        <div class="row tasks bonus">
                                ...
                                <div class="campaign_logo">
                                    <? if ( isset( $shabbos_task->subject_image_id ) ) { ?>
                                    <img alt="" src="/images/stickers/Sticker-<?=$shabbos_task->subject_image_id . 
                                    	($shabbos_task->subject_image_id == '3968888978' ? '.png' : '.gif');?>">
                                    <? } ?>
                                </div>
                                ...
                                <div class="cell">
                                    ...
                                    <? if ($label_name == 'Shabbos Mevorchim' and $shabbos_task->mandatory_qty > 0) 
                                       ...
                                       if ($label_name == 'Shabbos Mevorchim' and $shabbos_task->mandatory_qty == 0 and $shabbos_task->quantity > 0)
                                        echo "<i>Your quota is: $shabbos_task->desc minutes of tehillim</i><br/>";
                                    ?>
