...
if (isset($_POST['action'])) {
    ...
    if ($action == "produce_report") {
        ...
        //set dates
        $dates['start'] = array( 2457004, 2457011 );
        $dates['end'] = array( 2457010, 2457017 );
        ...
        $sql = "SELECT report_name FROM reports 
            ...
            AND visibility != 'none' 
            and start_date >= 2457004  
            and end_date <= 2457017  
            ORDER BY start_date"; 
        //echo $sql;   
        $query = mysql_query($sql);
    ...
    <body>
        ...
        <div class="body left marking_missions">
            ...
            <div class="infobox noprint">
                Chanuka missions include 2 weeks worth of missions.
            </div>
            
            <form name="date_tasks_report" id="date_tasks_report" action="date_tasks_print_chanuka.php" method="post" accept-charset="UTF-8">
