			...
			$(document).ready(function() {
				...
				$('#Continue').click(function() { 
                                    if (!$(".checkbox_enroll").is(":checked")) {
                                        ...
                                        window.location = "register_children_2.php";
                                    }
				});
				...
				$('.checkbox_enroll').click(function() { 
					...
					if ($(this).attr("checked") == true) {
						...
						$('#user_registration_fee_' + user_id).val(REGISTERAMOUNT);
                                                $.post('update_user_session.php', {user_id : user_id, fee : REGISTERAMOUNT});
					}
														...
														<li>
															<span class="box">
																<p class="input">
																	...
																	<label for="enroll-12345">I would like to enroll this child in the Tzivos Hashem 5775 program. ($<?=REGISTERAMOUNT;?>)</label>
																</p>
															</span>
														</li>
