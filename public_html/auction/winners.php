...
$sql = "select s.school_name, u.user_id, u.first, u.last, p.prize_id, p.prize_name, c.class_grade, c.class_sub  
        ...
        where aw.auction_id = 72 order by ";
...
$i = 0;
echo "<table>";
echo "<tr><th>&nbsp;</th><th>Prize Level</th><th>Prize ID</th><th>Prize</th><th>Student ID</th><th>Name</th><th>School</th><th>Grade</th></tr>";
while ( $row = mysql_fetch_assoc( $result ) ) {
	...
	echo "<tr><td>" . ++$i . "</td><td>" . $level . "</td><td>" . $row['prize_id'] . "</td><td>" .
