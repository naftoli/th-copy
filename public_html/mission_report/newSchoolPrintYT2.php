	...
	<script>
		$( function() {
			$(".arrow-left").click( function() {
				...
				window.location.href = "newSchoolPrintYT2.php?school=" + school + "&grade=" + grade + "&user=" + student + "&dblSided=" + dblSided + "&showDate=" + showDate;
			});
			...
			$(".arrow-right").click( function() {
				...
				var dblSided = <?=$dblSided?>;
				var showDate = <?=$showDate?>;
				window.location.href = "newSchoolPrintYT2.php?school=" + school + "&grade=" + grade + "&user=" + student + "&start=" + "&dblSided=" + dblSided + "&showDate=" + showDate;
			});
