	...
	<script>
		$( function() {
			$("#oneCol").click( function() {
				...
				var end = <?=$_GET['end']?>;
				var cols = 1;
				var str = "newSchoolMark22.php?user=" + user + "&school=" + school + "&grade=" + grade + "&start=" + start + "&end=" + end + "&col=" + cols;
				window.location = str;
			});
			...
			$("#twoCols").click( function() {
				...
				var end = <?=$_GET['end']?>;
				var cols = 2;
				var str = "newSchoolMark2.php?user=" + user + "&school=" + school + "&grade=" + grade + "&start=" + start + "&end=" + end + "&col=" + cols;
				window.location = str;
			});
			...
			$(".arrow-left").click( function() {
				...
				window.location.href = "newSchoolMark2.php?school=" + school + "&grade=" + grade + "&user=" + student + "&start=" + start + "&end=" + end;
			});
