					...
					<ul class="list_second">
						<li>
							...
							<ul>
								...
								<?
								//for australian schools show old registration
								//if (in_array($admin->school_id, array(55, 66, 112))) {
								?>
...
<!--</li>-->
					...
					<ul class='list_second'>
						...
						-->
						<li><a href="date_tasks_report.php"><?=T_('Mark Missions')?></a>
	...
	-->
						...
						<li><a href="shabbos_mevorchim.php"><?=T_('WWTC Report')?></a></li>
					...
					<!--****************************************************-->
						...
						<li>
							<a href="http://v2.mashpia.com/login/frommashpia/instituiton_type/Institution%20Administrator/user_id/<?=$admin_user['admin_id']==2?56:$admin_user['admin_id'];?>/dashextra/<?php print base64_encode("/index/tstyle/schoolstemplate1"); ?>">
								<span class="icon">
						...
						<li>
							<a href="http://v2.mashpia.com/login/frommashpia/instituiton_type/Institution%20Administrator/user_id/<?=$admin_user['admin_id']==2?56:$admin_user['admin_id'];?>/dashextra/<?php print base64_encode("/index/tstyle/tanyatemplate1"); ?>">
								<span class="icon">
