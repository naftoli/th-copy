...
else if (preg_match("/nav/i",$_SERVER["HTTP_USER_AGENT"]) || preg_match("/Mozilla\/4\./", $_SERVER["HTTP_USER_AGENT"])) {
	$browser = "netscape";
} 
else {
	$browser = "other";
            	...
            	<div class="padding_top padding_left member_info_box">
                    ...
                    <div class="member_info">
                    	<ul>
                        	...
                        	<li><label>5770 Miles:</label> <span><?=number_format($cur_points, 2)?></span></li>
                        </ul>
                    </div>
                    <div class="clear"></div>
                </div>
