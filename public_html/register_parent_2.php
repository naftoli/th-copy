				...
				<div class="slider_container">
					...
					<div class="slider">
						...
						<div class="col_content">
							<h1>Step 2 - Associate Children</h1>
							...
							<!--<form action="" method="post" accept-charset="UTF-8" name="login">-->
								...
								<div class='infobox'>
									...
									2. Click 'Associate Child'<br />
									3. Do the same for each child
									<br /><br />
									Tip:<br />
							...
							<!--</form> -->
										...
										<?
										//if admin has children in buffalo or morristown girls school, show $40 registration
										$action = "https://www.mashpia.com/register_parent_3.php";
										$exceptions = array( 37, 48 );
										foreach ( $admin->children as $child ) {
										    if ( in_array( $child->school_id, $exceptions ) ) {
										        $action = "https://www.mashpia.com/register_parent_3_40.php";
                                                break;
										    }										    
										}
										?>
