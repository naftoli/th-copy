<?php
// import the global variables for the system outside of the public_html directory....
require_once($_SERVER['DOCUMENT_ROOT']."/../includes/globals.php");
/**
 * The current user that we are deploying on. (make sure we are deploying to the correct location)
 *
 * retrived from running whoami on the shell.
 */
define( 'SHELL_USER', trim( shell_exec( 'whoami' ) ) );
/**
 ...
 * @var string
 */
define('BRANCH', SHELL_USER === "mashpia" ? 'master' : 'staging'); // only use the master branch if the user is mashpia. Otherwise this is a staging enviroment...
/**
 ...
 */
define('TARGET_DIR', '/home/' . SHELL_USER . '/'); // deploy to the current users folder....
/**
 ...
 * @var boolean
 */
define('DELETE_FILES', false); // do not delete, just rsync....
/**
