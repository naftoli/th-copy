...
?>
			...
			<script type="text/javascript" src="jquery.form.js"></script> 
 			<script>
				...
				function delete_new_group_type(div_name) {
					$(div_name).css({backgroundColor: "#ff0000"}).fadeOut("slow");	
				}
			...
			<div class="slider">
				...
				<div class="col_content">
                        ...
                        <div class="module_content">
                            <div class="list">
                                <ul>
									...
									<? if ($num_rows == 0) : ?>
										<li>										
											<span class="label editable" name="label"><?=T_("No Group Types Found");?></span>
										</li>																		
									<? else :?>
                    ...
                    <div class="wizard_nav">
                        <p><a class="button rfloat" href="manage_divisions.php?camp_id=<?=$camp_id;?>">Next</a></p>
                        <br class="clear" />
                    </div>
				</div>
			</div>
