...
<body class="blue">
    ...
    <div class="nav">
        ...
        <ul>
            <li class="icon_back"><a href="campaigns.php">Back</a></li>
...
<noscript><p class="js_alert">Notice: You have javascript disabled.<br />Some parts of the site will not function without javascript.</p></noscript>
        ...
        <div id="main">
            ...
            <div class="one_column padding_left campaign_main">
                <div class="medalImage medal_l12">
                </div>
			...
			__!<Not Enrolled>!__
			<li><a href="__!BASE_URI!__&action=overview" class="icon_ranks">Enroll</a></li>
			__!</Not Enrolled>!__
			__!<Enrolled>!__
			<li><a href="__!BASE_URI!__&action=simulator" class="icon_back_to">Simulator</a></li>
			<li><a href="__!BASE_URI!__&action=mission_entry" class="icon_ranks">Mission Entry</a></li>
			<li><a href="__!BASE_URI!__&action=medals" class="icon_medals">Medals</a></li>
			__!</Enrolled>!__
		</ul>
            </div>
        </div>
