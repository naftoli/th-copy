...
$mission_marks_updater->mission_marks_update_by_subject_id($user_id, $subject_id);
*/
...
function get_tlses() {
	...
	while ($row = mysql_fetch_assoc($rows)) {
		...
		//////////echo 'STEP ONE) SUBJECT: ' . $subject_id . ' TRACK ID:' . $row['track_id'] . ' LEVEL:' . $row['level'] . '<br />';
...
function get_missions($track_level_school_type) {
	...
	/////////echo 'SUBJECT ID:' . $track_level_school_type->subject_id . ' TRACK ID:' . $track_level_school_type->track_id . ' LEVEL:' . $track_level_school_type->level . ' SCHOOL TYPE:' . $track_level_school_type->school_type_id . '<br />';
	...
	while ($row = mysql_fetch_assoc($rows)) {
		...
		//////////echo 'SUBJECT ID:' . $mission->subject_id . ' MISSION NAME:' . $mission->mission_name. ' COMPLETED:' . $mission->completed . '<br />';
...
/*
echo '<br /><br /># OF MISSIONS:' . count($missions) . ' MEDAL ORD:' . $medal_ord . '<br /><br />';
