            ...
            <div class="three_column padding_top">
              <div class="content">
                    <div id="slider">
                      <ul class="enroll">
                            <li>
                                <div class="slider_title">Chayal's Commitment</div>
                                <div class="scroll-pane">
                                    <form>
                                	<div class="mainbox">
                                    	<div class="col2_image iconl_books"></div>
                                        <div class="col2_text">How many lines do you already know?
                                            	<input type="text" id="spinner-1" class="spinner" value="0" disabled="disabled" />
                                                We only use this number to know from what line to begin your worksheets.
                                        </div>
                                        <div class="clear"></div>
                                        <div class="button button_icons">
                                            <div><a href="camp_enroll_4.php" class="icon_enroll">Enroll Now</a></div>
                                        </div>
                                    </div>
                                    </form>
                                </div>
