...
(function($, undefined) {
    ...
    jPlayerBlogPlaylist = function(cssSelector, playlist, options) {
		var self = this;
		...
		this.cssSelector.artist = this.cssSelector.cssSelectorAncestor + " .jp-artist"; // Note that the text is written to the decendant li node.
    ...
    jPlayerBlogPlaylist.prototype = {
		...
		_highlight: function(index) {
			...
			if(this.playlist.length && index !== undefined) {
                ...
                $('.tz-blog-title').html(this.playlist[index].title);
                $('.tz-blog-artist').html(this.playlist[index].artist);
		...
		next: function() {
            ...
            if((parseInt(this.current) + parseInt(1)) < this.playlist.length){
                var index = parseInt(this.current) + parseInt(1);
            } else {
                var index = 0;
            }
