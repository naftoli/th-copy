...
//            console.log(media);
		...
		_highlight: function(index) {
			if(this.playlist.length && index !== undefined) {
                ...
                $('.tz-jp-title').html(this.playlist[index].title);
                $('.tz-jp-artist').html(this.playlist[index].artist);

                $('.tz-music-content .item-music').fadeOut(2000);

                $('.tz-music-content .item-music'+index+'').fadeIn(1000);

//                $('.item-music-title').html(this.playlist[index].title);
//                $('.item-music-image').attr('src',this.playlist[index].image);
//                $('.item-music-intro').html(this.playlist[index].descrip);
			}
		},
