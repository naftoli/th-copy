<?
// https://www.mashpia.com/admin_users_register_two.php?admin_id=2&school_id=58

if ( isset($_POST['login_username']) )
{
	echo "<input type='hidden' name='=== login_username exists ===' value='=== login_username exists ==='>\n";
}
else
{
	echo "<input type='hidden' name='=== login_username DOES NOT exist ===' value='=== login_username DOES NOT exist ==='>\n";
}
...
echo "<input type='hidden' name='dual_auth' value='" . $dual_auth . "'>\n";

if ($dual_auth) 
{
	echo "<input type='hidden' name='HERE 1' value='HERE 1'>\n";
...
{
	echo "<input type='hidden' name='HERE 2' value='HERE 2->" . var_dump($admin_auth) . "'>\n";
	
	require('admin_auth_two.php');
}
else
{
	echo "<input type='hidden' name='HERE 3' value='HERE 3'>\n";
