...
<html>
    <head>
		...
		<style>#printModal{text-align: center;display: inline-block;width: 100%;padding: 10px;color: #000;}</style>
    </head>
    ...
    <body>
        ...
        <div class="body left marking_missions">
            ...
            <form name="date_tasks_report" id="date_tasks_report" action="print_missions2.php" method="post" accept-charset="UTF-8">
            ...
            <? if ($school_id > 0) : ?>
				...
				<div class="noprint infobox">
					PLEASE NOTE: NEW printing instructions! (see below)<br />
					Use ONLY Mozilla Firefox.<br />
					Please do a test printing on the computer you will use for printing missions throughout the year.
				</div>
	            ...
	            <div class="noprint">
	                ...
	                <div class="infobox" style="font-size: 16px;">
	                	...
	                	1. Print from Firefox.<br />
	                	2. Set Scale to 90%.<br />
	                	3. Set Margins:<br />
                ...
                <div class="infobox2 marking_list clearfix noprint">
                    ...
                    <div class="date_list select_box">                  
                        ...
                        <select name="date_list" class="sSelect">
                            <? for ($report_number = 0; $report_number < count($reports); $report_number++) {
                                $report = $reports[$report_number];
								
								if ($start_date == 0) {
									$jd = unixtojd();
								}
								if (($start_date == $report->start_date && $end_date == $report->end_date) || ($jd >= ($report->start_date-6) && $jd <= ($report->end_date-6)) ) {
