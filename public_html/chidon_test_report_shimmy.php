...
foreach ($schools as $id => $school) {
    $sql = "select tc.*, u.first, u.last, u.gender, u.school_type_id, c.*, a.admin_email, a.admin_phone_mobile, a.admin_phone_mobile2, a.admin_phone_home
            from th_chidon tc 
...
<HTML>
    ...
    <BODY>
        ...
        Total Chidon Children: <?=$totalChildren?>
    </body>
</html>