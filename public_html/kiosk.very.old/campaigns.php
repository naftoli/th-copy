...
$subjects_result = mq("SELECT subjects.subject_id, subject_name, subject_type, subjects.black_image_id FROM subjects JOIN school_subjects ON (subjects.subject_id = school_subjects.subject_id AND school_id = {$user_row['school_id']}) WHERE subject_type NOT IN ('school_points', 'home_points') ORDER BY subject_name"
/*SELECT subjects.subject_id, subjects.subject_name, subjects.black_image_id
            ...
            <div>
                <div class="three_column">
                  ...
                  {?>
                        ...
                        <?=linkImgFile($row['black_image_id'],NULL,NULL," style='float:left;margin:20px 0 0 15px;'");?>
                        <a href="#" style="padding-left:20px;"><?=$row["subject_name"]?></a></li>
                 <?}?>
                  </ul>
                </div>
            </div>
