...
$medal_data = mysql_fetch_assoc(mq("
SELECT profile_photo_id, medal_name, subject_name, missions_required, missions_required_total
...
<title><?=T_('Prof_medals').' - '.T_('Tzivos Hashem Management System')?></title>
                      ...
                      <ul class="missions">
                            <li>
                                ...
                                for ($n=0; $n<$medal_data['missions_required']; $n++)
                                {
                                    ...
                                    $hdate_arr = dateToHebrewSplit($c_jd);
