...
<DIV class="noprint">
    <input type="button" value="PRINT" onclick="window.print();"> 
            ...
            <DIV class="letter" style="position:absolute; left:50px;">
                    ...
                    <DIV style="text-align:left;">
We are thrilled to open our seventh year of Chayolei Tzivos Hashem. We have simplified the program and created many new features for this year in order that you can integrate Tzivos Hashem in your class curriculum.                    </DIV>
                    <br />
