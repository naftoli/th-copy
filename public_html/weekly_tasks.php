                            ...
                            <div class="row tasks bonus">
                                    ...
                                    <div class="days">  
                                        ...
                                        <div class="cell text_input">
                                            <input value="<?=$date_task_mark->done_qty;?>" type="text" onblur="update_mark(this, <?=$date_task_mark->date_task_id;?>, <?=$weekly_task->mark_date;?>)" onkeypress="return number_validation(event);" maxlength="6">
                                        </div>
                                        <? endif; ?>
                                    </div>
                                    ...
                                    <div class="campaign_logo">
                                        <? if ( isset( $weekly_task->subject_image_id ) ) { ?>
                                        <img alt="" src="/images/stickers/Sticker-<?=$weekly_task->subject_image_id . 
                                    		($weekly_task->subject_image_id == '3968888978' ? '.png' : '.gif');?>">
                                        <? } ?>
                                    </div>
