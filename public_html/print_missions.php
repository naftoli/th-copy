...
if (isset($_POST['action'])) {
    ...
    if ($action == "produce_report") {
		...
		header("Location: mission_report/newPrint.php?user_id=$user_id&school_id=$school_id&class_id=$class_id&start_date=$start_date&end_date=$end_date&showDate=$showDate&dblSided=$dblSided");
		exit;
	}
}
...
<html>
    ...
    <body>
        ...
        <div class="body left marking_missions">
            ...
            <form name="date_tasks_report" id="date_tasks_report" action="print_missions.php" method="post" accept-charset="UTF-8">
