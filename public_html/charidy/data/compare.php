        ...
        <table>
            ...
            foreach ($info as $email => $other) {
                foreach ($other as $row) {
                    ...
                    if ($admin_id = matchByEmail($email)) echo $admin_id;
                    echo "</td><td>";
                    if ($admin_id = matchByPhone($row['phone'])) echo $admin_id;
                    echo "</td><td>";
                    if ($admin_id = matchByName($row['fname'], $row['lname'])) echo $admin_id;
                    echo "</td><td>";
                    if ($admin_id = matchByAddress($row['address'])) echo $admin_id;
