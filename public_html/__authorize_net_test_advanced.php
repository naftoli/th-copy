...
<?php
//
// if submit, then post transaction to authorize.net
//
								...
								<div class="module" id="module-info">
									...
									<?php															
															if($response_array)
															{
																...
																echo "<br> Response code" . $response_array[0] . " = ";
																...
																echo "<br><br>Message: " . $response_array[3] . "<br>";
																echo "<br>Authorization code: " . $response_array[4] . "<br>";
																echo "<br>Transaction ID: " . $response_array[6] . "<br>";
															...
															if(!$response_array && $submit)
															{
																echo "<br><br>Transaction failed. Please try again later<br>";
															}
															
															// write record to to SQL table:
