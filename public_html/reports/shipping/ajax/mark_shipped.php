...
if($debug) $status['post'] = [$checked, $params];
// use a swich statement incase type is pulled from another source later
switch($params[0]){
    case 'rank':
        include(dirname(__FILE__)."/../functions/get_ranks.php");
        ...
        break;
    case 'medal':
        include(dirname(__FILE__)."/../functions/get_medals.php");
        ...
        break;
    case 'hachayol':
        include(dirname(__FILE__)."/../functions/get_hachayols.php");
