...
/*
if (isset($admin_user['auths']['school'][0]) && $admin_user['auth'] != 'super') {
    require_once 'class.schoolClasses.php';
    $c = new SchoolClasses($admin_user['auths']['school'][0]);
    $classes = $c->getClasses();
} else {
    $classes = array();
    $class_grades = array(
        'Pre1a', '1', '2', '3', '4', '5', '6', '7', '8'
    );
}
 * 
 */
            ...
            $(function() {
                ...
                $("#submit").click( function() {
                    ...
                    if (!$("#allGrades input").is(":checked") && !$(".grades input").is(":checked")) {
                        if (errors != '') 
                            errors += '\n';
                        errors += "You must choose a class.";
                    }
