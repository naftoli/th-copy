...
<? if (!empty($admin_user) && isset($menu_type)) : ?>
	...
	<? if ($menu_type == 'super') : ?>
		<? $url_id = ''; ?>
            <li><a href="admin_shipping_report_new.php"><?=T_('Shipping Report 5773')?></A>
            <li><a href="hachayol_report.php"><?=T_('Hachayol Report 5773')?></A>
            ...
            <li><a href="promotions.php">Rally promotion list for Choni</a></li>           
            <li></li><br /> 
