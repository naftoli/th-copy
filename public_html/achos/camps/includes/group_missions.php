...
$sql = "SELECT * FROM camp_campaigns WHERE camp_id=" . $camp_id . " AND active=1 AND group_task=1";
								...
								<ul>
									...
									<li>
										<span class="action">
											<span class="tasks">
												<span>
													<a class="button overlay" title="Tasks" href="content.php?output=overlay_group_tasks&mission_name=<?=urlencode($camp_campaigns[$cno]->camp_missions[$mno]->mission_name);?>&camp_mission_id=<?=$camp_campaigns[$cno]->camp_missions[$mno]->camp_mission_id;?>&group_task=1">
