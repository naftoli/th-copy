...
$arrPoints = header_icorpa_points(array("user_code" => $user_row['user_code']));
...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<head>
		...
		<script type="text/javascript">
			// old: <?php print $cur_points; ?> - new: <?php print $arrPoints['all_points']; ?>
...
<?php
	...
	echo "<input type='hidden' name='newPoints' value='" . $arrPoints['all_points'] . "'>";
