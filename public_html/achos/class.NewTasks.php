...
class NewTasks {
        ...
        if ($this->user['class_id']) {
            ...
            if ( mysql_num_rows( $result ) > 0 ) {
                ...
                if ( is_null( $row['track_id'] ) || is_null( $row['level'] ) ) {
                    echo $this->user_id . " has no year and/or level for yoma depagra.<br />"; 
                    return false;
                } else {
    ...
    public function createMission( $name ) {
        $this->setSubject( 40 ); 
        if ( $this->getUserTrack() ) {
            ...
            $sql = "select * from date_tasks_missions 
                    ...
                    and mission_description = 'Yom Holedes Mission' 
            ...
            if ( $num > 0 ) {
                ...
                $sql = "insert into date_tasks_missions set 
                        ...
                        mission_name = '" . $name . "' , 
                        mission_description = 'Yom Holedes Mission', 
