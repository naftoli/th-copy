                            ...
                            <ul>
                                <li>
                                    ...
                                    <div class="inner">
                                        ...
                                        <h3><span class="icon"></span>Step 1: PRE-EXISTING SCHOOLS ONLY - Upload new Class List</h3>
                                        <div class="innerP">
                                            <p>1. Download the template spreadsheet file and fill in all the mandatory fields (marked by a *).</p>
                                            <p>Please Note: You MUST fill in the First Name, Last Name, English Date of Birth, Gender, and Mission Type fields of each student filled out.</p>
                                        ...
                                        <h3><span class="icon"></span>Step 2: PRE-EXISTING SCHOOLS ONLY - Platoon transition</h3>
                                        <div class="innerP">
                                ...
                                <li>
                                    ...
                                    <div class="inner">
                                        ...
                                        <div class="innerP">
                                            <p>Click <a href="registration_brochure.php">here</a> to download form.</p>
                                        </div>
                                ...
                                <li>
                                    ...
                                    <div class="inner">
                                        <h3><span class="icon"></span>Step 1: Get teachers to make sure that ALL their students register before RH</h3>
                                        <div class="innerP">
                                        ...
                                        <h3><span class="icon"></span>Step 2: Register Students for 5774</h3>
                                        <div class="innerP">
                                        ...
                                        <div class="innerP">
                                            ...
                                            <p>Please make sure you have uploaded photos for new students by ????</p>
                                ...
                                <li>
                                    ...
                                    <div class="inner">
                                        <h3>Step 1: Personalize Your Schools Mission Sheets</h3>
                                        <h3><span class="icon"></span>Step 2: Summer Missions Data Entry</h3>
                                        <div class="innerP">
                                            <p>Please make sure to collect the summer missions as soon the children come back from school.</p>
                                        </div>
                                        <h3><span class="icon"></span>Step 3: Print Tishrei missions before Chof Vov Elul</h3>
                                        <div class="innerP">
                                            <p>On Monday Chof Vov Elul all your students will be unregistered. You will no longer be able to print 
                                            or mark missions until they are registered again. Please print out Tishrei missions before the 
                                            children are unregistered.</p>
                                        </div>
                                    </div>
                                </li>
                                <!--
