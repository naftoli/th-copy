...
<html xmlns="http://www.w3.org/1999/xhtml" dir="<?=$dir?>">
	...
	<body onload="check_next_page();">
		...
		<FORM name="parent_registration" method="post" action="register_parent_2_new.php">
				...
				<div class="slider_container">
					...
					<div class="slider">
						...
						<div class="col_content">
							...
							<form method="post" action="register_parent_new.php" accept-charset="UTF-8" name="submit"  onsubmit="return validation();"> 								
										...
										<div class="lists form">
											<ul>
												...
												<li>
													...
													<span class="input"><input name="password2" type="password"  id="password2" value='<?=$admin->password?>' /></span>
												</li>
