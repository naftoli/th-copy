				...
				<div class="slider_container">
					<div class="slider">
						...
						<h1>School Registration</h1>
							...
							<form name="registration_2" id="registration_2" action="registration_2.php" method="post" enctype="multipart/form-data" accept-charset="UTF-8"> 
								<? if ($admin->school_id > 0) : ?>
										...
										<div class="lists form">
											<ul>
												<li>
													...
													<span class="input"><input name="school_name" type="text" value="<?=isset($school)?$school->school_name:'';?>" /></span>
												</li>
												<li>
													<span class="label"><label for="school_name_he">School Name in Hebrew</label></span>
													<span class="input"><input name="school_name_he" type="text" id="input" value="<?=isset($school)?$school->school_name_he:'';?>" /></span>
													<div class="clear"></div>
													<!--<div id="vk"></div>-->
												</li>
												<? if ( !$h_school ) { ?>
												...
												<li>
													...
													<span class="input"><input name="school_address1" type="text" value="<?=isset($school)?$school->school_address1:'';?>" /></span>
													...
													<? if (isset($school) && $school->school_city != "") : ?>
														<span class="input city"><input name="school_city" type="text" value="<?=isset($school)?$school->school_city:'';?>" /></span>
													<? else : ?>
														<span class="input city"><input name="school_city" type="text" placeholder="City" /></span>
													<? endif; ?>

													<? if (isset($school) && $school->school_state != "") : ?>
													<span class="input state"><input name="school_state" type="text" value="<?=isset($school)?$school->school_state:'';?>" /></span>												
													<? else : ?>
													<span class="input state"><input name="school_state" type="text" placeholder="State" value="<?=isset($school)?$school->school_state:'';?>" /></span>
													<? endif; ?>
													
													<? if (isset($school) && $school->school_postal != "") : ?>												
													<span class="input zip"><input name="school_postal" type="text" value="<?=isset($school)?$school->school_postal:'';?>"  /></span>
													<? else : ?>
													<span class="input zip"><input name="school_postal" type="text" placeholder="Zip" value="<?=isset($school)?$school->school_postal:'';?>"  /></span>
													<? endif; ?>
												</li>
												...
												<li>
													...
													<span class="input"><input name="school_phone" type="text" value="<?=isset($school)?$school->school_phone:'';?>" /></span>
												</li>
