...
if (isset($_POST['submit'])) {
	...
	$sql = "select date_task_id from date_tasks where date_tasks_mission_id > 95 order by date_task_id limit 1";
...
<html>
                ...
                $("#createNewTask").click( function() {
                	...
                	if (task == '') {
                		...
                		$.post('ajax/createTask.php', {
                			...
                			if (data == 1) {
                				alert("Task Created");
                				window.location.href = 'student_tasks.php'; 
                				return true;
                			} else {
                				alert(data);
                				return false;
    ...
    <body>
        ...
        <p><b>Welcome!</b><br /><br />
        	<i>Please choose your tasks that you feel you can accomplish.</i><br />
        	<!--
        ...
        <form method="post" action="student_tasks.php">
            	...
            	<div id="new">
            		<fieldset>
            			...
            			<div id="newTaskDiv" style="display: none">	            			
	            			Task: (e.g. Modeh Ani)<br />
	            			<input type="text" id="newTask" size="30" /><br /><br />
	            		</div>
            			
            			<div id="newTaskDescDiv" style="display: none">
	            			Description: (e.g. as soon as I woke up with my hands together)<br />
	            	...
	            	<div id="<?=$id?>">
	                    <fieldset>
							...
							foreach ($tasks[$id] as $task) {
								...
								if ($task['points']) {
									echo " <span style='font-size: 10px;'>(" . $task['points'] . " points)</span>";
								}
								echo "</li>";
