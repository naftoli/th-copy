    ...
    return (
      <Row id='address-row'>
        ...
        {!this.props.hideShipping &&
          <Fragment>
            <AddressAutofill
              accessToken='pk.eyJ1IjoibmFmdG9saXIiLCJhIjoiY2xsZTR5NHFuMDBzeTNzdWxqcnd1ZGJ0ZSJ9.7M6yPlYYDHRE-QcRUp_z9A'
            >
              <Col xs={12} xl={6}>
                <label>Address 1</label>
                <Input name="address-1" autocomplete="address-line1" id={getName('address1')} placeholder='792 Eastern Parkway'
              ...
              <Col xs={12} xl={6}>
                ...
                <Input name="address-2" autocomplete="address-line2" id={getName('address2')}
              ...
              <Col xs={6} xl={showPhone ? 6 : 4}>
                <label>City</label>
                <Input name="city" autocomplete="address-level2" id={getName('city')}
              ...
              <Col xs={3} xl={showPhone ? 3 : 2}>
                <label>State</label>
                <Input name="state" autocomplete="address-level1" id={getName('state')}
              ...
              <Col xs={3} xl={showPhone ? 3 : 2}>
                <label>Zip</label>
                <Input name="zip" autocomplete="postal-code" id={getName('postal')}
