      ...
      <Row id='HQSettingsRow'>
        ...
        <Col sm={6} xl={3}>
          ...
          <Input { ...numberProps } name='chayolei_fee' step=".01" max='9999.99'
            value={ this.getValue( base.chayolei_fee ) } onChange={ this.onNumberChange } disabled />
        </Col>

        <Col sm={6} xl={3}>
          <Label>Chidon Registration Fee</Label>
          <Input { ...numberProps } name='chidon_fee' step=".01" max='9999.99'
            value={ this.getValue( base.chidon_fee ) } onChange={ this.onNumberChange } disabled />
        </Col>

        <Col sm={6} xl={3}>
          <Label>Tanya Registration Fee</Label>
          <Input { ...numberProps } name='tanya_fee' step=".01" max='9999.99'
            value={ this.getValue( base.tanya_fee ) } onChange={ this.onNumberChange } disabled />
        </Col>

        <Col sm={6} xl={3}>
          <Label>Rewards Registration Fee</Label>
          <Input { ...numberProps } name='rewards_fee' step=".01" max='9999.99'
            value={ this.getValue( base.rewards_fee ) } onChange={ this.onNumberChange } disabled />
        </Col>

        <Col sm={4}>
          <Label>Balance</Label>
          <Input { ...numberProps } name='balance' step=".01" max='9999.99' min={ undefined }
            value={ this.getValue( base.balance ) } onChange={ this.onNumberChange } disabled />
        </Col>

        <Col sm={4}>
          <Label>Early Bird</Label>
          <Date value={ base.early_bird }
            onChange={ this.onDateChage } disabled />
        </Col>
        ...
        <Col sm={4}>
          ...
          <Input { ...numberProps } name='child_fee'
            ...
            onChange={ this.onNumberChange } placeholder='Default' disabled />
        </Col>
      </Row>
