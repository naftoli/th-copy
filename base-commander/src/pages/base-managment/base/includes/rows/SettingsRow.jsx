...
export class SettingsRow extends Component {
  ...
  render () {
    ...
    let { 
      pic_mission_type,     store_reset,    hachayol_extra,
      school_gender,        print_parent_tasks,
      hachayol_extra_total, allow_parent_tasks,
    } = base;
        ...
        <Row className='special-options'>
          ...
          <Col xs={12} sm={6}>
            ...
            <Input type='number'
              ...
              value={ hachayol_extra === null || hachayol_extra === undefined ? '' : hachayol_extra } />
              
            <Checkbox
                name='hachayol_extra_total'
                checked={ hachayol_extra_total || false }
