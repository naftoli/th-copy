...
export const RankCard = ({
  ...
  const onChange = (user_id, rank_ord) => ({ target }) => {
    onChangeProp(user_id, rank_ord, target.checked);
  };
  ...
  const classNames = classnames('print RankCard', { 'permanent': permanent });

  return (
    <div className={classNames}>
      {showPrinted &&
        <div className='no-print'>
          <Checkbox checked={!!printed} onChange={onChange(user_id, rank_ord)}>
            Printed
          </Checkbox>
        </div>
      }
