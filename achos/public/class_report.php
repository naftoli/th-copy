...
<html>
    ...
    <body>
        ...
        <form action="easytable/index.php" method="post">
            <p>Use the following options to generate your report.</p>
            <fieldset>
                <legend>Dates</legend>
                <select name='from' id="from">
                    <option value='0'>Choose start Parsha</option>
                    <?php
                ...
                <select name='to' id="to">
                    <option value='0'>Choose end Parsha</option>
                    <?php
                    foreach ($oldParshos as $p) {
                        echo "<option value='" . $p['end'] . "'>" . $p['name'] . " - 5777</option>";
                    }
                    foreach ($parshos as $parsha) {
                        echo "<option value='" . $parsha['end'] . "'>" . $parsha['name'] . " - 5778</option>";
                    }
                    ?>
                </select>
            </fieldset>
            ...
            <fieldset id="data">
                <legend>Data</legend>
                <input type="checkbox" name="visits" /> Visits<br />
    ...
    <script>
        $(function() {
            ...
            $("#submit").click(function(e) {
                ...
                if (from == 0 || to == 0) {
                    errors.push('You must choose the parshos that you want on the report.\n');
                } else if (from > to) {
                    errors.push('Start parsha cannot be after end parsha!\n');
                }
