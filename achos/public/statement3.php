...
if (!in_array($school_id, array(55, 66, 112, 79, 61)))
		   ...
		   <?
			if($user['registered'] && (!$camp_season) ):
				...
				if (!preg_match("/Sorry, there was an error/", $strResult))
				{
					...
					$cur_points += intval(@$arrResultPoints[0]);
			...
			?>
                    <div class="member_info">
                    	<ul>
                        	...
                        	<li><label>5772 Miles:</label> <span id="year_miles"><?=number_format($cur_points, 2)?></span></li>
                        </ul>
                    </div>
		   <? endif; ?>
                	...
                	<div class="scan_card">
                    	<div class="scan_card_inside">
                            ...
                            <? if ($user['registered'] || $camp_season): ?>
                                ...
                                <FORM action="statement3.php" method="post" id="scancard" accept-charset="UTF-8" autocomplete="off">
                                <DIV>
