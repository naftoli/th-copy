...
$add_ons = array();
$sql = "SELECT * FROM school_add_ons WHERE YEAR=2011 ORDER by add_on";
        ...
        <script>
                        ...
                        for (cno = 0; cno < children.length; cno++) {
                            ...
                            if (user_registration_fee > 0) {
                                ...
                                if (enrolled) {                                 
                                    ...
                                    //var url = "https://www.mashpia.com/update_user_registered.php?user_id=" + user_id;
            ...
            function checkEnrollment(user_id) {
                ...
                if ( document.getElementById(checkBoxId).checked == false ) {
                    alert("You have to enroll the child in the Tzivos Hashem 5773 program first.");
                    return false
                }
                else {
                    return true;
                                                        ...
                                                        <li>
                                                            <span class="box">
                                                                <p class="input">
                                                                    ...
                                                                    <label for="enroll-12345">I would like to enroll this child in the Tzivos Hashem 5773 program. ($<?=REGISTERAMOUNT;?>)</label>
                                                                </p>
                                                            </span>
                                                        </li>
