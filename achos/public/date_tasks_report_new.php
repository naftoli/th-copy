    ...
    <body>
        ...
        <div class="body left marking_missions achos">
            ...
            <div class="module clearfix generate">
                <p>Mark Scoreboard by choosing your parsha and clicking 'Go'.</p>
            </div>
            
            <form name="date_tasks_report" id="date_tasks_report" action="date_tasks_report_new.php" method="post" accept-charset="UTF-8">
                    ...
                    <div class="date_list select_box">                  
                        ...
                        <select name="date_list" class="sSelect">
                            <? for ($rno = 0; $rno < count($parshos); $rno++) : ?>
                                <? $report = $parshos[$rno]; ?>
                                <? if ( (count($parshos) == 1) || ($start_date && $start_date == $report['start'] && $end_date == $report['end']) || (!$start_date && $report_start_date >= $report['start'] && $report_start_date <= $report['end']) ) :  ?>
