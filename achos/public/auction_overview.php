                  ...
                  <div class="scroll-pane">
                    <div class="col2_text">
                      <p>
                        ...
                        <?=T_('You can buy raffle tickets with as few as 5 miles!')?>
                      </p>
                      <p>
                        <br><span style="font-size: 150%;"><?=T_('New Miles may be scanned until the cut-off date.')?></span><br>
                        <?=T_('Miles earned after each cut-off date count toward the next auction.')?>
                      </p>
                      <p>
                        <br><span style="font-size: 150%;"><?=T_("Mitzvos don't expire and neither do miles.")?></span><br>
                        <?=T_('Earn at least 150 new miles since the last cut-off date, and reuse ALL of this year’s miles in the auction. Earn at least 1200 miles during the year and reuse miles of all previous years in the final auction of the year.')?>
                      </p>
                    </div>
                  </div>
                </div>
