...
if ($admin_auth[0] == 'school') { 
    ...
    if ( $numSchools > 1 && !isset( $_POST['submit'] ) ) {
        ...
        if ( ($numSchools == 1 && !isset( $_POST['submit'] )) || (isset( $_POST['school'] ) && !isset( $_POST['class'] ) ) ) {
            ...
            $points = header_icorpa_points_multi( $codes );
            ...
            foreach ( $user_classes as $grade => $arr ) {
            	...
            	?>
            		...
            		$cur_points += isset( $points[$code] ) ? $points[$code]['hebrew_points'] : 0 ;
            		echo "<tr><td>" . $grade . "</td><td>" . $user['last'] . "</td><td>" . $user['first'] . "</td><td>" . $cur_points . "</td></tr>";
            	} 
