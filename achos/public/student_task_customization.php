...
if ( isset( $_POST['submit'] ) && $_POST['submit'] == 'Go' ) {
    ...
    $both = $tc->getCampaignsForChild( $_POST['user'] );
...
<html>
            ...
            $( function() {             
                        ...
                        <? if ( isset( $start_date ) ) { ?>
                            ...
                            $.getJSON('ajax/getTasks.php', {
                                ...
                                $(".task").click( function(e) { 
                                    ...
                                    if ( checked ) {
                                        var campaignChecked = $(o).parent().parent().parent().parent().find('.campaign').is(":checked");
                                        if ( !campaignChecked ) {
                                            $(o).parent().parent().parent().find('.campaign').attr('checked', 'checked');
                                            var campaign = $(o).parent().parent().parent().parent().find('span').text();
                                            updateArray( campaigns, checked, campaign );
                                            updateArray( campaignsAdded, !checked, campaign );
                ...
                $('#save').click( function() { 
                    ...
                    $.post('ajax/customize.php', { 
                        ...
                        alert( "Saved." );
                        //history.go(0);
                        window.location = 'student_task_customization.php';
                    });
                });
    ...
    <body>
        ...
        <form method="post" action="student_task_customization.php">
                ...
                <div id="selection" style="padding: 10px;">
                    ...
                    <div class="date_list select_box">   
                        ...
                        <SELECT name="parsha" id="parsha">
                            ...
                            foreach ($parshos as $parsha) {
                                ...
                                if (isset($_POST['parsha']) && ($_POST['parsha'] == ($parsha['start'] . ':' . $parsha['end']))) {
                    ...
                    <div class="dates" style="width: 300px !important;">                  
                    ...
                    <div style='margin-left: 19% !important'>
