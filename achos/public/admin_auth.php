...
if (!function_exists('check_auth_admin')) 
{
	...
	{
		//echo "<input type='hidden' name='1) I AM HERE' value='1) I AM HERE->" . $admin_id . "->" . $auth . "'>\n";
		...
		if ($admin_id && !empty($auth)) 
		{
			...
			if ($row = mysql_fetch_assoc($result)) 
			{
				...
				$auth_2 = hash_hmac('ripemd128', strtolower($row['username']) . $row['password'], '53fdc95857aac68970159dd07e7c3782');
