...
if (isset($_POST["action"])) {
	...
	if ($_POST["action"] == "update") {
		$sql = "UPDATE schools SET shipping_first='" . $_POST['shipping_first'] . "', shipping_last='" . $_POST['shipping_last'] . "', shipping_address1='" . $_POST['shipping_address1'] . "', shipping_phone='" . $_POST['shipping_phone'] . "', shipping_address2='" . $_POST['shipping_address2'] . "', shipping_city='" . $_POST['shipping_city'] . "', shipping_state='" . $_POST['shipping_state'] . "', shipping_postal='" . $_POST['shipping_postal'] . "', shipping_country='" . $_POST['shipping_country'] . "' WHERE school_id=" . $school_id;
		$query = mysql_query($sql);
