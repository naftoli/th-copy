        ...
        <SCRIPT type="text/javascript">
            $(document).ready(function() {
                    ...
                    $.ajax({
                        ...
                        {                                                       
                            ...
                            //if (true)
                            {
                                ...
                                parameters = parameters + $("#grand_total_id").html() + ";" + <?=$school_id?>;                              
                                var url = "add_functions.php?function_name=register_students&parameters=" + parameters;
                                                                alert(url);
                                $.getJSON(url); 
                                
                                //update students that are being registered to be enrolled by default into all campaigns
                                $.each($("#students_table").find("tr[name=student_row]"), function() {  
                                    var user_id = $(this).attr("data");
                                    var registered = $(this).find("#user_registered").html().trim();
                                    if (registered == "") {
                ...
                */
                ...
                {   
                    if ($("#school_id").val() > 0)
                        var url = "register_school_students_40.php?school_id=" + $("#school_id").val();
                    else
                        var url = "register_school_students_40.php?school_id=<?=$admin->school_id;?>";
                    
                    <? if (!empty($reg)) echo "var url = url + '&registered=1'"; ?>
