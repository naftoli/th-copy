			...
			<div class="body">
				...
				<div class="noprint">
						...
						<script>
							...
							{		
								...
								$("#school_id").change(function () {
									alert("please be patient, if the school that you chose has many students, the page will take some time to load");
									get_classes();
									page_loaded = true;
								});
								...
								function get_report_two()
								{
									...
									var url = "user_possible_medals.php?school_id=" + $("#school_id").val() + "&class_id=" + class_id + "&end_date=" + $("#end_date").val();
					...
					<p>
						...
						<label>
							End Date
							<input type="text" name="end_date_disp" id="end_date_disp" value="<?=es(dateToHebrew($end_date))?>" onClick="get_board_date(this.form, 'end_date', true);">
						</label>
