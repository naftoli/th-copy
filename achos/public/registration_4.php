					...
					<div class="slider">
						...
						<div class="col_content left">
                            ...
                            <? if ( !$h_school ) { ?>
								...
								<p>Register your school for ONLY $600 and you receive:</p>
									...
									<div class="module_content">
										<div class="lists form">
											<ul>
												...
												<li class="right">
													<div class="box">
														<h4>Discount Package Price: $600</h4>
													</div>   
												</li>
											</ul>
										</div>
								...
								<p>For ONLY $50 each registered student will receive:</p>
									...
									<div class="module_content">
										<div class="lists form">
											<ul>
												...
												<li>
													<div class="box">
														<h4>40 Hachayol Magazines ($50 value)</h4>
												...
												<li>
													...
													<div class="box">
														<h4>Mission Sticker Book and Sticker Boards ($13 value)</h4>
                                                ...
                                                <li>
                                                    <div class="box">
                                                        ...
                                                        <p>Offer students 1 spectacular end of the year Chinese auction.</p>
                                                    </div>   
                                                </li>
												<li class="right">
													<div class="box">
														<h4>Total Value: $134</h4>
													</div>   
												</li>
												<li class="right">
													<div class="box">
														<h4>Discount Package Price: $50</h4>
													</div>   
												</li>
											</ul>
										</div>
							...
							<? } else { ?>
                                ...
                                <p>Registration fee for Hebrew School 5774 is $600.</p>
