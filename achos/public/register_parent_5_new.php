...
if (!isset($_POST["message"])) {
	header("http://mashpia.com/admin.php");
}
else {
	$data = explode("\n", $_POST["message"]);
}
				...
				<div class="slider_container">				
					<div class="slider">					
						...
						<div class="col_content">						
							<h1>Summary</h1>	 
							<form action="https://www.mashpia.com" method="post" accept-charset="UTF-8" name="login"> 							
									...
									<div class="module_content">
										<div class="lists form">
											<ul>
												<li>
													<div class="box">
														<h4>Thank you for registering your <?=(count($admin->children)<2)?'child':'children'?> in the Tzivos Hashem 5771 Program.</h4>
													</div>
												</li>
												<li>
