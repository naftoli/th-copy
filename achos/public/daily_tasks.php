                    ...
                    <? if ($value == $user->daily_labels[$dlno]) : ?>
                        ...
                        <div class="marking module">
                            <div class="row top_row">
                                ...
                                <div class="cell">
                                    <?=$label . "<br /><span style='font-size: 12px'>1 point (10/16)</span>";?>
                                </div>
                            </div>
                            ...
                            <div class="row tasks mission<?=($daily_task->master_task_id)?'':' master'?>"> 
                                    <? else : ?>
                            <div class="row tasks bonus<?=($daily_task->master_task_id)?'':' master'?>">                   
                                    <? endif; ?>
                                ...
                                <div class="cell">
                                    <?
                                    	echo $daily_task->task_name;
										if ($daily_task->mandatory_qty > 0)
											echo " <span style='color: red; font-weight: bold;'>*</span>";
										echo "<br /><span style='font-size: 9px;'>" . $daily_task->description . "</span>";
										//if (!$daily_task->master_task_id) {
										//	echo "<span style='font-size: 10px;'> " . $daily_task->points . " point(s) </span>";
										//}
									?>
                                </div>                                                  
                            </div>
                        ...
                        <?
                        if ($as->getLevel() == 1 && strtolower($label) == 'my hiskashrus') {
                        	echo "<div style='font-size: 9px;'>* Chitas includes Chumash, Tehilim, Tanya, Sefer Mitzvos, Hayom Yom, Rebbe and Rebbitzen Kaptial, my Kapital.</div>";
                        }
                        ?>
