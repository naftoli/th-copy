...
<HTML>
    ...
    <BODY>
        ...
        if (isset($_POST['submit'])) {
            ...
            $sql = "insert into 5775_orders values('', $school_id, $bc, $posters, $brochures, '$method', null)";
            //echo $sql;
			 * 
			 */
			...
			$sql = "insert into posters 
					...
					posters = $posters";
            if (mysql_query($sql)) {
            	//send email to th about order
            	$subject = "School poster order";
            	$to = 'cth@tzivoshashem.org';
				$message = $schools[$school_id] . " has just ordered $posters posters.";
                ...
                <table>
                    ...
                    <tr>
                        <td colspan="2" align="center">
                            <input type="checkbox" name="terms" id="terms" /> I would like to order a poster(s) for my school for $50/ea.
                            <br />I understand that my credit card on file will be charged.
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2" align="center">
