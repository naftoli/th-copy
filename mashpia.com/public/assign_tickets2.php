...
<html>
    ...
    <body>
        ...
        <div class="body left marking_missions">
            ...
            <form name="date_tasks_report" id="date_tasks_report" action="assign_tickets2.php" method="post" accept-charset="UTF-8">
	...
	function showTickets() {
		$.post('ajax/getPrizes.php', { auction : auction }, function( success ) {
			...
			for (var p in prizes) {
                ...
                html += "' id='" + prize.prize_id + "'><div class='prizePoints'>" + prize.prize_points;
                html += " Point Prize <span class='prizeQty'><input type='text' ";
				...
				html += "/></span></div>";
				html += "<div class='prizeName'>" + prize.prize_name + "</div></div>";
			}
			html += "<div style='clear: both'></div><br />";
			html += "<p class='noShow'>" + points + " Points available for " + userName + "</p>";
			html += "<p class='noShow'>Tzivos Hashem Hakhel Auction 5776</p>";
			...
			$('.save').click( function() {
				...
				$('.prizeQty input').each( function() {
					...
					var prize_id = $(this).parent().parent().parent().attr('id');
					var pPoints = parseInt($(this).parent().parent().parent().find('.prizePoints').text());
					if (qty > 0) {
