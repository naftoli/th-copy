...
if (isset($_POST['action'])) {
    ...
    if ($action == "produce_report") {
		...
		header("Location: mission_report/newSchoolPrintYT.php?user=$user_id&school=$school_id&grade=$class_id&showDate=$showDate&dblSided=$dblSided");
		exit;
	}
}
...
<html>
    ...
    <body>
        ...
        <div class="body left marking_missions">
            ...
            <form name="date_tasks_report" id="date_tasks_report" action="print_missionsYT.php" method="post" accept-charset="UTF-8">
                ...
                <div class="infobox2 marking_list clearfix noprint">
                    ...
                    <div class="date_list select_box">                  
                        ...
                        <select name="date_list" class="sSelect">
                            <option value="1">Pesach 5779</option>
                        </select>
