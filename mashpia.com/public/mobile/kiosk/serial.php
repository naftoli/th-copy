...
<body>
    ...
    <nav class="navbar navbar-expand-lg">
        <a class="navbar-brand">
            <img src="/mobile/img_new/tzivos-hashem-logo-color.png" id="navbar-logo" alt="" height="50" width="50">
        </a>
        <span class="navbar-text navbar-title mx-auto">
            Tzivos Hashem Kiosk
        </span>
    </nav>
    ...
    <section class="barcode-scanner">
        <div class="flex">
            ...
            <div id="barcode_scanner" class="viewport"></div>
            <div id="toggle-manual">
                <img src="/mobile/img_new/scanner-2-color-red-svg.svg" alt="manual" />
            </div>
        </div>
    </section>
