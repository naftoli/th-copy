            ...
            <div style="margin-bottom: 20px;">
                ...
                <div id="buttons" style="text-align: center;">
                    <div id="rightButtons" style="float: <?=$alignmentRight?>; text-align:<?=$alignmentRight?>;">
						...
						<?php if ( !isset($_COOKIE['lang']) || $_COOKIE['lang'] != 'he' ) { ?>
						<a id="printLink" href="/mission_report/newParentPrint.php?bypass=1&admin=<?=encrypt_decrypt('decrypt', $_COOKIE['admin_id'])?>" target="_blank" style="<?=$desktop ? "" : "display: none"?>">
