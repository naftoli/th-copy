            ...
            <form id="custom-task-form">
                <div class="modal-body">
                    ...
                    <fieldset id="Parshos" style="border: 1px solid #ccc;padding: 10px;margin-bottom: 15px;">
                        ...
                        <div align='center'>
                            <input type='button' id='toggleParshos' class="btn btn-danger" style="background-color: #1b2b51;border-color:#1b2b51;" value='Toggle Parshos' />
                            <br/>
                        </div>
                        <?
                ...
                <div class="modal-footer">
                    <button type="submit" class="btn btn-danger i18n" data-key="create-button" id="create-task-bottom" style="background-color: #1b2b51;border-color:#1b2b51;">Create</button>
                    <button type="button" class="btn btn-danger i18n" data-key="cancel-button" data-dismiss="modal" style="background-color: #1b2b51;border-color:#1b2b51;float: left;">Cancel</button>
                </div>
        ...
        $("#custom-task-form").submit(function(event){
            ...
            $.post("ajax/createParentTask.php", post_data, function(data){
                try {
                    ...
                    if (!data.success) {alert("Server Error: " + data.error_message + ". If you believe this is in error, please contact techinical support."); return false;} // show the error to the user...}
