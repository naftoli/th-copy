...
function getEmailMsg($trans_id) {
    ...
    $msg .= "<br /><br /><footer style='font-size: 9px; color: grey;'>HQ Address: 792 Eastern Parkway<br />
            Brooklyn, NY 11213<br /><br />To Unsubscribe please click <a href='/unsubscribe.php'>here</a></footer>";
