...
function sendEmail( $amount, $trans_id, $email ) {
    ...
    $message .= "<p>P.S. Please retain this as proof of receipt of your tax-deductible donation of $" . number_format( $amount, 2 ) . "USD. No goods or services were provided for this donation. Tzivos Hashem is a 501(c)3 nonprofit corporation.</p>";
