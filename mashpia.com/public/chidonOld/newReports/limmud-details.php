...
$info['learned'] = $chidon->getTotalMinutesLearned($user_id, $test_num, true);
?>
<!DOCTYPE html>
<html>
    <head>
    ...
    <body>
        ...
        <p>
            ...
            Daily Minutes Required: <?= $minutes[$info['test_type']] ?><br /><br/>
            Total Minutes Required (as of today): <?= $info['required'] ?><br />
            Total Minutes Learned (as of today): <?= $info['learned'] ?><br />
        </p>
        <table>
            <tr>
                <th>Learning Day #</th>
            ...
            foreach ($details as $day => $row) {
                ...
                echo "<tr><td>" . ($day + 1) . "</td><td>" . $heDay . "</td><td>" . $amount . "</td><td>" . $balance .
