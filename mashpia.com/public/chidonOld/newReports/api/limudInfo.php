...
//    $learned = array_sum($totals);
    ...
    $info[] = [
        ...
        'yesod'     => isset($marks[$student['th_chidon_id']][$test_num]['maven']) ? $marks[$student['th_chidon_id']][$test_num]['maven'] : 0,
        'yediah'    => isset($marks[$student['th_chidon_id']][$test_num]['pro']) ? $marks[$student['th_chidon_id']][$test_num]['pro'] : 0,
        'havonah'   => isset($marks[$student['th_chidon_id']][$test_num]['expert']) ? $marks[$student['th_chidon_id']][$test_num]['expert'] : 0,
        'iyun'      => isset($marks[$student['th_chidon_id']][$test_num]['genius']) ? $marks[$student['th_chidon_id']][$test_num]['genius'] : 0,
