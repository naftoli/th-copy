...
//    $learned = array_sum($totals);
    ...
    $info[] = [
        ...
        'yesod'     => $marks[$student['th_chidon_id']][$test_num]['maven'],
        'yediah'    => $marks[$student['th_chidon_id']][$test_num]['pro'],
        'havonah'   => $marks[$student['th_chidon_id']][$test_num]['expert'],
        'iyun'      => $marks[$student['th_chidon_id']][$test_num]['genius'],
