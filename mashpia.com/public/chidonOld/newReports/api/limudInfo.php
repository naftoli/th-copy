...
//    $learned = array_sum($totals);
    ...
    $info[] = [
        ...
        'yesod'     => ($scores[$student['th_chidon_id']][$test_num]['maven'] ?? 0 . '/' . $num_questions['maven']),
        'yediah'    => ($scores[$student['th_chidon_id']][$test_num]['pro'] ?? 0 . '/' . $num_questions['pro']),
        'havonah'   => ($scores[$student['th_chidon_id']][$test_num]['expert'] ?? 0 . '/' . $num_questions['expert']),
        'iyun'      => ($scores[$student['th_chidon_id']][$test_num]['genius'] ?? 0 . '/' . $num_questions['genius']),
