...
<? if ($prize['img']){ ?>
    <div class="form_control">
        Current Picture: <br><img src="<?= $prize['img'] ?>" width="175" /><br><br>
    </div>
<? } ?>
<form method="post" action="./update.php" enctype="multipart/form-data">
    <input type="hidden" id="id" name="id" value="<?= $prize['chidon_credit_prize_id']?>" required/>

    <div class="form_control">
        <label for="prize_name">Prize Name</label>
        <input type="text" id="prize_name" name="prize_name" value="<?= $prize['prize']?>" required/>
    </div>
    ...
    <div class="form_control">
        ...
        <input type="number" id="credits_needed" name="credits_needed" value="<?= $prize['credits'] ?>" required/>
    </div>
