            ...
            foreach ($tracks as $track => $desc) {
                ...
                $tasks = [
                    [
                        ...
                        ".<br /><i>You need to learn " . $minutes[$track] . " minutes per day.</i><br />
                        <span class='audioLinks' style='display: none;'><i>Links to the audio of today's unit(s): 
                        " . implode(', ', $audioLinks) . "</i></span>
