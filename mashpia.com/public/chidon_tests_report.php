...
foreach ($schools as $id => $school) {
    $sql = "select tc.*, u.first, u.last, c.*, a.admin_email, a.admin_phone_mobile, a.admin_phone_mobile2, a.admin_phone_home
            from th_chidon tc 
                ...
                foreach ($info as $grade => $other) {
                    foreach ($other as $user_id => $more) {
                        foreach ($more as $name => $tests) {
                            ...
                            echo "<tr><td>" . $grade . "</td><td>" . $name . "</td><td>" . $t1a . "</td><td>" . $t1b . "</td><td>" .
