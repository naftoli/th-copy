	...
	<BODY>
		...
		<DIV CLASS="body">
			...
			<? endif; ?>
				...
				<FORM  name="admin_received_stats_form" id="admin_received_stats_form" action="admin_received_stats2.php" method="post" accept-charset="UTF-8">				
					...
					<? if ($go == '1') : ?>
						...
						<FORM action="admin_received_stats2.php" method="post" accept-charset="UTF-8" name="y">    						
