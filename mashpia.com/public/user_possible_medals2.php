    ...
    if (count($subject->subject_users) > 0)
    {
        ...
        foreach ($subject->subject_users as $subject_user)
        {
            ...
            foreach ($subject->subject_medals as $subject_medal)
            {
                ...
                //{
                //	echo "missions_required:" . $missions_required . " possible_missions:" . $possible_missions . "<br />";
                //}
...
//                    {
                        ...
                        <tr>
                            <td style="width:250px;">
                                <span style="color:darkblue;"><?=$subject_user->user_id;?></span>&nbsp;&nbsp;&nbsp;
                            </td>

                            <td style="width:250px;">
                                <span style="color:darkblue;"><?=$subject_user->user_serial;?></span>&nbsp;&nbsp;&nbsp;
                            </td>
                            ...
                            <td style="width:100px;">
                                <span style="color:blue"><?=count($subject_user->possible_medals);?></span>
                            </td>
                        </tr>
                        <?
//                    }
