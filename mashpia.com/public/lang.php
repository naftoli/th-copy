...
// T_(text) => transalate text to correct language
...
// Transalate from the database with varchars
...
// Transalate from the database with text
...
// create some vars with the days of the week
