...
*/
		...
		_init: function() {
			...
			if(this.flash.used) {
				...
				if($.jPlayer.browser.msie && (Number($.jPlayer.browser.version) < 9 || $.jPlayer.browser.documentMode < 9)) {
					var objStr = '<object wmode="' + this.options.wmode + '" id="' + this.internal.flash.id + '" classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" width="0" height="0" tabindex="-1"></object>';
		...
		stop: function() {
            ...
            var blog_music = jQuery('.blog-music');
            if(blog_music){
                jQuery('.blog-music').animate({
                    bottom:-70
                },1000);
                jQuery('#jquery_jplayer_blog').fadeOut(500);
                jQuery('.music-pause-blog').fadeOut();
                jQuery('.music-play-blog').fadeIn();
            }
		},
		playHead: function(p) {
