...
if (isset($_POST['action'])) {
    ...
    if ($action == "produce_report") {
        ...
        $user->get_rank();      
        $user->get_user_tracks($subject_id, $start_date, $end_date, array(), $user->lang_id);    
    }
}
...
<? if ($school_id < 1) : ?>
            <form name="date_tasks_report" id="date_tasks_report" action="date_tasks_report_he.php" method="post" accept-charset="UTF-8">
...
<DIV id="tasks_div">
    ...
    <? include("daily_tasks_new_he.php"); ?>
