...
if ($school_id > 0) 
{
    ...
    $sql = "SELECT * FROM reports 
            ...
            and start_date = 2456824  
            and end_date = 2456900 
            ORDER BY start_date"; 
    //echo $sql;   
    $query = mysql_query($sql);
    while ($row = mysql_fetch_assoc($query)) {
    ...
    <body>
        ...
        <div class="body left marking_missions">
            ...
            <div class="infobox noprint">
                Summer missions include 12 weeks worth of missions. Shelach until Ki Teitzei.<br />
                You can only print for each child individually.<br />
            </div>
            
            <form name="date_tasks_report" id="date_tasks_report" action="date_tasks_print_summer.php" method="post" accept-charset="UTF-8">
                        ...
                        <div class="marking module clearfix">
                            ...
                            <p class="print_week">
                            	...
                            	<? if ($showDate > 0) { ?>
	                        		...
	                        		<? 
	                        		if ($showDate == 2) {
										echo " <span>[" . date('M j', jdtounix($start_date)) . ' - ' . date('M j, Y', jdtounix($end_date)) . "]</span>&nbsp;&nbsp;&nbsp;";
									}
