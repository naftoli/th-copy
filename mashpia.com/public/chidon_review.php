    ...
    <BODY>
        ...
        foreach ($schools as $id => $school) {
            ...
            foreach ($users[$id] as $user) {
                ...
                ?>
                IMPORTANT NOTE: The Chidon Shabbaton is a major undertaking, and requires extensive coordination to ensure everyone's safety at all times. For this reason, changes to information submitted after enrollment will incur additional charges: <br />
                <ul>
                    <li> From Feb 23, changes can be made through your account at an additional charge of $50.</li>
