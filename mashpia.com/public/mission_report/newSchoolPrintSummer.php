...
if (isset($_GET['school'])) {
	...
	header("Location: ../print_missions_summer.php");
	exit;
}

//summer 5785
// $start = 2460112; // June 16, 2023
$start = 2460846; // June 20, 2025
// $end = 2460195; // September 7, 2023
$end = 2460929; // September 11, 2025
	...
	<script>
		$( function() {
			$(".arrow-left").click( function() {
				...
				window.location.href = "newSchoolPrintSummer.php?school=" + school + "&grade=" + grade + "&user=" + student + "&dblSided=" + dblSided + "&showDate=" + showDate;
			});
			...
			$(".arrow-right").click( function() {
				...
				var dblSided = <?=$dblSided?>;
				var showDate = <?=$showDate?>;
				window.location.href = "newSchoolPrintSummer.php?school=" + school + "&grade=" + grade + "&user=" + student + "&start=" + "&dblSided=" + dblSided + "&showDate=" + showDate;
			});
