...
<html>
	...
	<body>
		<div class="infobox">
			IMPORTANT: Printing Missions will only work properly in FIREFOX BROWSER<br />with the settings that are shown BELOW!
		</div>
                    ...
                    <li>
                        <h3><span class="icon"></span>Print Instructions</h3>
							...
							<p>Step 3: In the second tab set Margins:<br />
								<div style="margin-left: 30px; font-size: 14px; font-weight: bold;">
									Top: 0.3<br />
									Left: 0.3<br />
									Right: 0.0<br />
									Bottom: 0.0<br />
