	...
	<script>
		$( function() {
			$(".arrow-left").click( function() {
				...
				window.location.href = "newSchoolPrint2.php?school=" + school + "&grade=" + grade + "&user=" + student + "&start=" + start + "&end=" + end + "&dblSided=" + dblSided + "&showDate=" + showDate;
			});
        ...
        function printAll() {
            $(".userMission").each( function() {
                ...
                setTimeout(function(){window.frames["print_frame"].print();},1000);
            });
        }
	</script>
</html>