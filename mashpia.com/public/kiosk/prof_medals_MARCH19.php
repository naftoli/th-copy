		...
		if (!in_array($subjectId,$right_subjects))
                        ...
                        { 
                            ...
                            elseif((isset($user_medals[$medal['subject_id']][$medal['medal_ord']]) && $user_medals[$medal['subject_id']][$medal['medal_ord']]))
                            {
                                ...
                                {
                                ?>
                                <div class="active"><div class="check_on"></div><a href="prof_medal.php?subj=<?=$medal['subject_id'];?>&medal=<?=$medal['medal_ord'];?>&birth=<?=$birth_date;?>&last=<?=($medal['medal_ord']==$medal_sum);?>"><?=linkImgFile($medal['profile_photo_id'], 96, 100);?></a></div>
                                <?}
                            }
                            else
                            {
                                ...
                                {
                            ?>
                                <div><a href="prof_medal.php?subj=<?=$medal['subject_id'];?>&medal=<?=$medal['medal_ord'];?>&birth=<?=$birth_date;?>&last=<?=($medal['medal_ord']==$medal_sum);?>"><?=linkImgFile($medal['profile_photo_id'], 96, 100);?></a></div>
                                <?}
                            }
                            $medals_num++;
                        }
