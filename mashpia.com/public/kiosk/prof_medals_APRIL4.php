              ...
              <div class="content">
                    ...
                    ?>
                            <li>
                                ...
                                <div class="medalImage"><?=linkImgFile($medal['subject_gold_image_id'], 200, 210);?></div>
                                <div class="medals">
                    <?      }
                            $class_str = (isset($user_medals[$medal['subject_id']][$medal['medal_ord']]) && $user_medals[$medal['subject_id']][$medal['medal_ord']]) ? ' class="active"' : '';
                    ?>
                                    <div<?=$class_str;?>><a href="prof_medal.php?subj=<?=$medal['subject_id'];?>&medal=<?=$medal['medal_ord'];?>" onClick="return false; //disable for now"><?=linkImgFile($medal['profile_photo_id'], 96, 100);?></a></div>
                    <?
                        }
                    ?>
                                </div>
