...
// ----- Returns an array with user_id, subject_id, track_id, level, school_type_id, start_date (USER_TRACKS) ----- //
...
$sql = $sql . " WHERE subject_type NOT IN ('school_points', 'home_points') AND subjects.subject_id not in (27, 91)";
