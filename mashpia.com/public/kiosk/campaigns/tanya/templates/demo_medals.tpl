	<title>Medals - Tzivos Hashem Management System</title>
				...
				<div class="three_column padding_top">
					...
					<div class="content">
						...
						<div id="slider">
							...
							<ul>
<li>
	<div class='slider_title'>Tanya Baal Peh</div>
	<div class='medalImage'><IMG SRC='/file_view.php?id=1411150688' WIDTH='200' HEIGHT='210'  ALT='tanya.png'></div>
	<div class='medals'>
		__!Medal Page!__
	</div>
</li>
