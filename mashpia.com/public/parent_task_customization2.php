...
<html>
            ...
            $( function() {             
                ...
                $('#save').click( function() { 
                    ...
                    $.post('ajax/customize.php', { 
                        ...
                        alert( "Saved." );
                        //history.go(0);
                        window.location = 'parent_task_customization2.php';
                    });
                });
                ...
                $("#resetAll").click( function() {
                    ...
                    if (action === true) {
                    	var child = <?=$user?>;
                        $.post('ajax/resetChild.php', {user_id : child}, function(data) {
                            alert(data);
                            window.location = 'task_customization.php';
                        });
                    }
    ...
    <body>
        ...
        <form method="post" action="parent_task_customization2.php">
