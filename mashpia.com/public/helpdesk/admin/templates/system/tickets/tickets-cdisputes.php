...
?>
  <div class="container margin-top-container min-height-container" id="mscontainer">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active"><?php echo $msg_adheader29; ?> (<?php echo @number_format($countedRows); ?>)</li>
    </ol>
      ...
      <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 margin_top_10">
        <div class="panel panel-default">
            ...
            <div class="table-responsive">
              ...
              <thead>
               <tr>
                ...
                ?>
                <th style="width:5%">
                  <input type="checkbox" onclick="mswCheckBoxes(this.checked,'.panel-body');mswCheckCount('panel-body','delButton','mswCVal');mswCheckCount('panel-body','delButton2','mswCVal2');mswCheckCount('panel-body','delButton3','mswCVal3')">
                </th>
                <?php
                } else {
                ?>
                <th style="width:5%">
                  <input type="checkbox" onclick="mswCheckBoxes(this.checked,'.panel-body');mswCheckCount('panel-body','delButton2','mswCVal2');mswCheckCount('panel-body','delButton3','mswCVal3')">
                </th>
                <?php
                }
                ?>
              ...
              <tbody>
               ...
               if (USER_DEL_PRIV == 'yes') {
               ?>
               <td><input type="checkbox" onclick="mswCheckCount('panel-body','delButton','mswCVal');mswCheckCount('panel-body','delButton2','mswCVal2');mswCheckCount('panel-body','delButton3','mswCVal3')" name="del[]" value="<?php echo $TICKETS->ticketID; ?>"></td>
               <?php
               } else {
               ?>
               <td><input type="checkbox" onclick="mswCheckCount('panel-body','delButton2','mswCVal2');mswCheckCount('panel-body','delButton3','mswCVal3')" name="del[]" value="<?php echo $TICKETS->ticketID; ?>"></td>
               <?php
               }
               ?>
          ...
          <div class="panel-footer">
            ...
            if (USER_DEL_PRIV == 'yes') {
            ?>
            <button onclick="mswConfirmButtonAction('<?php echo mswSafeDisplay($msg_script_action); ?>','tickdel');return false;" class="btn btn-danger button_margin_right20" disabled="disabled" type="button" id="delButton"><i class="fa fa-trash fa-fw" title="<?php echo mswCleanData($msg_open23); ?>"></i> <span class="hidden-xs hidden-sm"><?php echo mswCleanData($msg_open23); ?></span> <span id="mswCVal">(0)</span></button>
            <?php
            }
            ?>
            <button class="btn btn-primary button_margin_right20" onclick="mswProcess('tickexp')" type="button" id="delButton3" disabled="disabled"><i class="fa fa-save fa-fw"></i> <span class="hidden-xs hidden-sm"><?php echo mswCleanData($msg_search25); ?></span> <span id="mswCVal3">(0)</span></button>
            <button onclick="mswConfirmButtonAction('<?php echo mswSafeDisplay($msg_script_action); ?>','tickopen');return false;" class="btn btn-success" disabled="disabled" type="button" id="delButton2"><i class="fa fa-unlock fa-fw" title="<?php echo mswCleanData($msg_open40); ?>"></i> <span class="hidden-xs hidden-sm"><?php echo mswCleanData($msg_open40); ?></span> <span id="mswCVal2">(0)</span></button>
          </div>
	        <?php
	        }
          ?>
