...
?>
  <div class="container margin-top-container min-height-container" id="mscontainer">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active"><?php echo $msg_adheader6; ?> (<?php echo @number_format($countedRows); ?>)</li>
    </ol>
