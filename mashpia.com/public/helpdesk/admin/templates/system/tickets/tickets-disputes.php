...
?>
  <div class="container margin-top-container min-height-container" id="mscontainer">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active"><?php echo $msg_adheader28; ?> (<?php echo @number_format($countedRows); ?>)</li>
    </ol>
          ...
          <div class="panel-body">
            ...
            <div class="table-responsive">
              ...
              <tr id="datatr_<?php echo $TICKETS->ticketID; ?>">
                ...
                <td><a href="?p=view-dispute&amp;id=<?php echo $TICKETS->ticketID; ?>" title="<?php echo mswSafeDisplay($msg_viewticket11); ?>"><?php echo mswTicketNumber($TICKETS->ticketID); ?></a>
                ...
                <td>
                 ...
                 ?>
                 <a href="?p=view-dispute&amp;id=<?php echo $TICKETS->ticketID; ?>&amp;editNotes=yes" onclick="iBox.showURL(this.href,'',{width:<?php echo IBOX_NOTES_WIDTH; ?>,height:<?php echo IBOX_NOTES_HEIGHT; ?>});return false" title="<?php echo mswSafeDisplay($msg_viewticket72); ?>"><i class="fa fa-file-text fa-fw"></i></a>
                 <?php
                 }
                 ?>
