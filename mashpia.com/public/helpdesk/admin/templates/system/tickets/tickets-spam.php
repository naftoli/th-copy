...
?>
  <div class="container margin-top-container min-height-container" id="mscontainer">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active"><?php echo $msg_adheader63; ?> (<?php echo @number_format($countedRows); ?>)</li>
    </ol>
      ...
      <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 margin_top_10">
        <div class="panel panel-default">
            ...
            <div class="table-responsive">
              <table class="table table-striped table-hover">
                <thead>
                  <tr>
                    ...
                    ?>
                    <th><?php echo $msg_showticket16; ?></th>
              ...
              <tbody>
               ...
               <td>
                 ...
                 ?>
                 <a href="?p=edit-ticket&amp;id=<?php echo $TICKETS->ticketID; ?>&amp;spam=yes" title="<?php echo mswSafeDisplay($msg_viewticket120); ?>"><i class="fa fa-pencil fa-fw"></i></a>
                 <?php
                 }
                 if ($MSTEAM->notePadEnable == 'yes' || $MSTEAM->id == '1') {
                 ?>
                 <a href="?p=view-ticket&amp;id=<?php echo $TICKETS->ticketID; ?>&amp;editNotes=yes&amp;spam=yes" onclick="iBox.showURL(this.href,'',{width:<?php echo IBOX_NOTES_WIDTH; ?>,height:<?php echo IBOX_NOTES_HEIGHT; ?>});return false" title="<?php echo mswSafeDisplay($msg_viewticket72); ?>"><i class="fa fa-file-text fa-fw"></i></a>
                 <?php
                 }
                 ?>
          ...
          <button onclick="mswConfirmButtonAction('<?php echo mswSafeDisplay($msg_script_action); ?>','tickdel');return false;" class="btn btn-danger button_margin_right20" disabled="disabled" type="button" id="delButton"><i class="fa fa-trash fa-fw" title="<?php echo mswCleanData($msg_open15); ?>"></i> <span class="hidden-xs hidden-sm"><?php echo mswCleanData($msg_open15); ?></span> <span id="mswCVal">(0)</span></button>
	        ...
	        ?>
	        <button onclick="mswConfirmButtonAction('<?php echo mswSafeDisplay($msg_script_action); ?>','tickaccept');return false;" class="btn btn-success" disabled="disabled" type="button" id="delButton2"><i class="fa fa-check fa-fw" title="<?php echo mswCleanData($msg_spam ); ?>"></i> <span class="hidden-xs hidden-sm"><?php echo mswCleanData($msg_spam ); ?></span> <span id="mswCVal2">(0)</span></button>
	        </div>
	        <?php
	        }
          ?>
