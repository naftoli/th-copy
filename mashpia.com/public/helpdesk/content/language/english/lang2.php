...
$msg_main20 = 'Your account access has been disabled.';
...
$msg_newticket35 = 'Max Files / Max Size Per File';
...
$msg_showticket30 = '<span class="highlight">{count}</span> User(s) in Dispute';
...
$msg_portal25 = 'Enter New Email Address';
$msg_portal26 = 'Update Email Address';
$msg_portal27 = '<b>{open}</b> open ticket(s)';
$msg_portal28 = '<b>{dis_open}</b> open dispute(s)';
$msg_portal30 = 'Invalid email address, try again..';
$msg_portal31 = 'Email address must be an alternative address..';
$msg_portal32 = 'Email already exists, please choose another..';
...
$msg_portal43 = 'Dispute: #{ticketID} - (Started by {name}, {count} user(s) in dispute)';
...
$msg_backup15 = 'Backup Completed and Email(s) Sent';

$msg_customfields = 'Order';
...
$msg_customfields14 = 'Selected Field(s) Deleted';
$msg_customfields15 = 'Current Custom Fields';
$msg_customfields16 = 'There are currently 0 custom fields to display';
$msg_customfields17 = 'Field Location';
$msg_customfields18 = 'Display on New Ticket Page';
$msg_customfields19 = 'Display on Ticket Reply Page';
$msg_customfields20 = 'Display on Admin Reply Page';
...
$msg_customfields28 = 'Admin Reply Fields Visible to Visitors';
$msg_customfields30 = 'Custom Field Configuration';
...
$msg_disputes8 = 'Manage Dispute Users';
$msg_disputes16 = 'There are currently 0 disputes to display.';
...
$msg_home26 = 'Open (Waiting for Support Team)';
$msg_home27 = 'Open (Waiting for Visitor)';
$msg_home28 = 'Closed';
$msg_home29 = 'Dispute Overview';
$msg_home30 = 'Ticket Overview';
$msg_home31 = 'Tickets - Waiting for Support Team';
$msg_home32 = 'Disputes - Waiting for Support Team';
$msg_home33 = 'Today';
...
$msg_home37 = 'Tickets';
$msg_home38 = 'Disputes';
$msg_home39 = 'Tickets - Waiting for Visitor';
$msg_home40 = 'Disputes - Waiting for Visitor';
$msg_home41 = 'There are currently 0 tickets to display';
$msg_home42 = 'Quick Links';
$msg_home43 = 'New (Waiting for Support Team)';
$msg_home44 = '#{ticket} &#8226; {name} &#8226; {priority} &#8226; {date}';
$msg_home45 = '#{ticket} &#8226; {name} &#8226; {priority} &#8226; {date} &#8226; {count} User(s) in Dispute';

$msg_kbase24 = 'Enable Category';
$msg_kbase25 = '(Disabled)';
$msg_kbase26 = 'Preview Answer';
$msg_kbase27 = 'Reset Voting Counts';
$msg_kbase28 = 'Enable Question';
$msg_kbase29 = 'Disable';
$msg_kbase34 = 'Order Display Updated';

$msg_imap = 'Add Account';
$msg_imap2 = 'Imap Account Configuration';
...
$msg_imap11 = 'Mailbox Folder Name';
...
$msg_imap19 = 'Imap Reply-to Email Address';
$msg_imap20 = 'Current Imap Accounts';
$msg_imap21 = 'There are currently 0 imap accounts to display';
$msg_imap22 = 'Imap Account Added';
$msg_imap23 = 'Imap Account Updated';
$msg_imap24 = 'Selected Imap Account(s) Deleted';
$msg_imap25 = 'Update Account';
$msg_imap26 = 'Please Select..';
$msg_imap28 = 'ID';
...
$msg_open22 = 'Opened by: <span class="highlight">{name}</span> on <span class="highlight">{date}</span> &#8226; Dept: <span class="highlight">{dept}</span> &#8226; Replies: <span class="highlight">{replies}</span> &#8226; User(s) in Dispute: <span class="highlight">{dispute}</span>';
$msg_open23 = 'Delete Selected Dispute(s)';
$msg_open24 = 'View Dispute';
$msg_open25 = 'Selected Dispute(s) Re-Opened';
$msg_open26 = 'Selected Dispute(s) Deleted';
$msg_open27 = 'New - Waiting for Support Team';
...
$msg_open29 = '<span class="highlight">#{ticket}</span> &#8226; Opened: <span class="highlight">{date}</span> &#8226; Priority: <span class="highlight">{priority}</span> &#8226; Dept: <span class="highlight">{dept}</span> &#8226; Replies: <span class="highlight">{replies}</span> &#8226; User(s) in Dispute: <span class="highlight">{dispute}</span><span class="floatrightclosed"><span class="highlight">{status}</span></span>';
$msg_open30 = 'Open - Waiting for Support Team';
...
$msg_settings59 = 'API Key';
$msg_settings60 = 'Public Key';
$msg_settings61 = 'Private Key';
$msg_settings62 = 'reCaptcha';
$msg_settings63 = 'Create Keys';
$msg_settings64 = 'Javascript Calendar Start Day';
...
$msg_systemportal21 = 'Enter Email Address';
...
$msg_user45 = 'Display Signature in Emails';
$msg_user51 = 'Cancel';
$msg_user54 = 'Has Ticket Notepad Access';
...
$msg_user63 = 'Between';
$msg_user64 = 'Has Delete Privileges';
$msg_user65 = 'Ticket \'From\' Name';
$msg_user66 = 'Ticket \'From\' Email Address';
...
$msg_viewticket58 = 'Add User to Dispute';
$msg_viewticket59 = 'Name';
$msg_viewticket60 = 'Email Address';
$msg_viewticket62 = 'Update Selected Users';
$msg_viewticket65 = 'Update Dispute Users';
$msg_viewticket66 = 'No users have been added to this dispute. Use the add tab to add user.';
...
$msg_viewticket90 = 'Ticket Reply Successfully Added &amp; Merged with Ticket #{ticket}';
...
$msg_bbcode26 = 'Click to Email Me';
$msg_bbcode28 = 'New tab/window';

$msg_edigest = 'N/A';
$msg_edigest2 = 'N/A';
$msg_edigest3 = '[#{ticket}-{priority}] {subject}';
$msg_edigest4 = 'Email Digest Completed - Started: {started}, Finished: {finished}';
$msg_edigest5 = 'Started By: {name}' . mswDefineNewline() . 'Last Reply: {updated}';
$msg_edigest6 = 'Started By: {name}' . mswDefineNewline() . '{count} User(s) in Dispute' . mswDefineNewline() . 'Last Reply: {updated}';
...
$msg_script34 = 'To add your own footer code, click &quot;Settings &amp; Tools > Other Options > Edit Footers&quot;';
$msg_script35 = 'To add your own footer code, click &quot;Settings &amp; Tools > Other Options > Edit Footers&quot;';
$msg_script36 = 'Close Window';
$msg_script37 = 'Sent via API. Awaiting Login.';
$msg_script38 = 'Close';
