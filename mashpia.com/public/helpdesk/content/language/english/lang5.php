...
$msadminlangpublic = array(
  ...
  'Other Pages',
  'Logged Out',
  'You have successfully logged out of the system.<br><br>Please wait...'
);
...
$msadminlang3_1 = array(
  ...
  'Reset ALL Passwords - If checked, auto generates a new password for any user where password field is left blank',
...
$msadminlang3_1dept = array(
  'If Displaying, Display On The Following Dates Only',
  'Options'
);
...
$msadminlang3_1createticket = array(
  ...
  'Please enter your name',
  'Department invalid, try again',
  'Please enter subject of ticket',
  ...
  'Please complete the {count} required fields via the "Additional Fields" (<i class="fa fa-list fa-fw"></i>) tab',
  'Required'
);
