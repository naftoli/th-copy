    ...
    <body>
        ...
        <div id="school_shabbaton">
            ...
            <form>
              ...
              <input type="checkbox" name="agreement2" id="agreement2" /> I understand that enrollment will not open for my students until I have completed the registration process, including registering all required staff.<br />
