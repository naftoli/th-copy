			...
			<DIV class="noprint">
				...
				<?php
					if($admin_user['auth'] == 'super' || count($admin_user['auths']['school']) != 1)
					{
						...
						<FORM action="admin_missions_available.php" method="get" accept-charset="UTF-8">
							<P>
...
if ($mission['subject_id'] == 4)
echo "<li>" . is_null($mission['mission_number']) ? '' : '#' . floatval($mission['mission_number']) . es($mission['mission_name']) . "</li>";
} 
?>
</OL>
<HR class="noprint">
