		...
		<script type="text/javascript">	
			...
			function get_todo_list(school_id)
			{
				if (category_id == 0)
					...
					var url = "ajax_get_todo_list.php?admin_auth=" + admin_auth + "&school_id=" + school_id + "&subject_id=" + subject_id + "&category_id=" + category_id;
		...
		<DIV class="ui_<?=$ui_type?> <?=$align_start?>">
			...
			<DIV class="body">
				...
				<DIV class="ui_body">
					...
					<DIV id="report_content" name="report_content" class="content" style="overflow: auto;">
