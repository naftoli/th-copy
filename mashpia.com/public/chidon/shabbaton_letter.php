      ...
      foreach ( $other as $grade => $children ) {
        foreach ( $children as $row ) {
          ...
          <div class="letter">
            ...
            This <strong>Monday, February 18, enrollment opens</strong> for the incredible four-day Chidon experience that drives our children to accomplish the unfathomable.<br /><br />
            ...
            Here is your link: [<a href="https://<?=$link?>"></a><?=$link?>].<br /><br />
