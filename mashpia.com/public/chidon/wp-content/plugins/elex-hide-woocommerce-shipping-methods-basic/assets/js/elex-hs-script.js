...
function elex_hs_edit_copy_rule(rule_name, action) {
    ...
    jQuery.ajax({
        ...
        success: function (response) {
            ...
            if (response['shipping_class'] !== undefined) {
            ...
            if (response['weight_action'] !== undefined) {
            ...
            if (response['filter_shipping_methods'] !== undefined) {
            ...
            if (response['filter_shipping_options'] !== undefined) {
                var ship_options = '';
                jQuery.each(response['filter_shipping_options'], function (key, val) {
                    ship_options += val + ',';
                });
                ship_options = ship_options.slice(0, -1);
                jQuery('#elex_hs_filter_shipping_options').val(ship_options);
            } else {
                jQuery('#elex_hs_filter_shipping_options').val('');
            }
            
            if (response['hide_shipping_methods'] !== undefined) {
            ...
            if (response['hide_shipping_options'] !== undefined) {
                var shipping_options = '';
                jQuery.each(response['hide_shipping_options'], function (key, val) {
                    shipping_options += val + ',';
                });
                shipping_options = shipping_options.slice(0, -1);
                jQuery('#elex_hs_hide_shipping_options').val(shipping_options);
            } else {
                jQuery('#elex_hs_hide_shipping_options').val('');
            }
            if (action == 'edit') {
