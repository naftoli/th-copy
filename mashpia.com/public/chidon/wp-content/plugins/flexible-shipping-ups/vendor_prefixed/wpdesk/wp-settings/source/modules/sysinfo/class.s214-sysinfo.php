...
class S214_Sysinfo
{
    ...
    {
        global $wpdb;
        if (!\class_exists('UpsFreeVendor\\Browser')) {
            require_once 'browser.php';
        }
        $browser = new \UpsFreeVendor\Browser();
        // Get theme info
        ...
        $return .= 'Language:                 ' . (\defined('UpsFreeVendor\\WPLANG') && \UpsFreeVendor\WPLANG ? \UpsFreeVendor\WPLANG : 'en_US') . "\n";
    ...
    {
        $caching = \function_exists('UpsFreeVendor\\wpsupercache_site_admin') || \defined('UpsFreeVendor\\W3TC') || \function_exists('UpsFreeVendor\\rocket_init');
    ...
    function get_host()
    {
        if (\defined('UpsFreeVendor\\WPE_APIKEY')) {
            $host = 'WP Engine';
        } elseif (\defined('UpsFreeVendor\\PAGELYBIN')) {
            $host = 'Pagely';
        } elseif (\UpsFreeVendor\DB_HOST == 'localhost:/tmp/mysql5.sock') {
            $host = 'ICDSoft';
        } elseif (\UpsFreeVendor\DB_HOST == 'mysqlv5') {
            $host = 'NetworkSolutions';
        } elseif (\strpos(\UpsFreeVendor\DB_HOST, 'ipagemysql.com') !== \false) {
            $host = 'iPage';
        } elseif (\strpos(\UpsFreeVendor\DB_HOST, 'ipowermysql.com') !== \false) {
            $host = 'IPower';
        } elseif (\strpos(\UpsFreeVendor\DB_HOST, '.gridserver.com') !== \false) {
            $host = 'MediaTemple Grid';
        } elseif (\strpos(\UpsFreeVendor\DB_HOST, '.pair.com') !== \false) {
            $host = 'pair Networks';
        } elseif (\strpos(\UpsFreeVendor\DB_HOST, '.stabletransit.com') !== \false) {
            $host = 'Rackspace Cloud';
        } elseif (\strpos(\UpsFreeVendor\DB_HOST, '.sysfix.eu') !== \false) {
            $host = 'SysFix.eu Power Hosting';
        } elseif (\strpos($_SERVER['SERVER_NAME'], 'Flywheel') !== \false) {
            $host = 'Flywheel';
        } else {
            // Adding a general fallback for data gathering
            $host = 'DBH: ' . \UpsFreeVendor\DB_HOST . ', SRV: ' . $_SERVER['SERVER_NAME'];
        }
        return $host;
    }
    /**
