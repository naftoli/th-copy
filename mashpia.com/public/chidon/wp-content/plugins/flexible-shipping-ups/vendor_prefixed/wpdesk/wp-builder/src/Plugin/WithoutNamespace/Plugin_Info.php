...
if (!\class_exists('UpsFreeVendor\\WPDesk_Buildable')) {
    require_once __DIR__ . '/Buildable.php';
}
if (!\class_exists('UpsFreeVendor\\WPDesk_Has_Plugin_Info')) {
 ...
 */
class WPDesk_Plugin_Info implements \UpsFreeVendor\WPDesk_Translatable, \UpsFreeVendor\WPDesk_Buildable, \UpsFreeVendor\WPDesk_Has_Plugin_Info
{
    /** @var string */
