 ...
 * @since       1.0.0
 */
class WPDesk_S214_Settings extends \UpsFreeVendor\S214_Settings
{
    ...
    public function enqueue_scripts($hook)
    {
        ...
        \wp_localize_script($this->slug . '-js', 's214_settings_vars', \apply_filters($this->func . 'localize_script', array('func' => $this->func, 'image_media_button' => \__('Insert Image', 'wpdesk-plugin'), 'image_media_title' => \__('Select Image', 'wpdesk-plugin'))));
    }
    /**
     * Date callback
     *
