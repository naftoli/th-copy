...
namespace UpsFreeVendor\WPDesk\Helper\Page;
 ...
 */
class LibraryDebugPage implements \UpsFreeVendor\WPDesk\PluginBuilder\Plugin\Hookable
{
    const PRIOTITY_LONG_AFTER_ALL_IS_LOADED = 999;
    /** @var LibraryDebug */
    private $library_debug;
    public function __construct(\UpsFreeVendor\WPDesk\Helper\Debug\LibraryDebug $library_debug)
    {
