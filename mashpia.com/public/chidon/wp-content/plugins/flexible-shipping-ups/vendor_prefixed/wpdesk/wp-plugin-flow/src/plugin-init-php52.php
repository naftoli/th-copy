...
if (\PHP_VERSION_ID > 50300) {
    ...
    if (!isset($plugin_init_factory)) {
        $plugin_init_factory = new \UpsFreeVendor\WPDesk\Plugin\Flow\Initialization\Simple\SimpleFactory();
    }
    $bootstrap = new \UpsFreeVendor\WPDesk\Plugin\Flow\PluginBootstrap($plugin_version, $plugin_release_timestamp, $plugin_name, $plugin_class_name, $plugin_text_domain, $plugin_dir, $plugin_file, $requirements, $product_id, $plugin_init_factory);
    $bootstrap->run();
