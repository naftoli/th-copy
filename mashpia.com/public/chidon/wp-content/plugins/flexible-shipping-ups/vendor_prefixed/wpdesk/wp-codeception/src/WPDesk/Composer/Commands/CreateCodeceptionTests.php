 ...
 */
class CreateCodeceptionTests extends \UpsFreeVendor\WPDesk\Composer\Codeception\Commands\BaseCommand
{
    use SedTrait;
    /**
     * Configure command.
    ...
    {
        if (!\copy($source, $dest)) {
            throw new \UpsFreeVendor\Composer\Downloader\FilesystemException($exceptionMessage);
        }
    }
    /**
