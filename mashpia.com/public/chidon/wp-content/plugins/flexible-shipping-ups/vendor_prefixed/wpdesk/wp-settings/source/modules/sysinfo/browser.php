...
class Browser
{
    ...
    function __toString()
    {
        ...
        //grabs the UA (user agent) string
        $UAline1 = \substr($text1, 0, 32);
        //the first line we print should only be the first 32 characters of the UA string
        $text2 = $this->getUserAgent();
        //now we grab it again and save it to a string
        $towrapUA = \str_replace($UAline1, '', $text2);
        //the rest of the printoff (other than first line) is equivolent
    ...
    function checkBrowserW3CValidator()
    {
        if (\stripos($this->_agent, 'W3C-checklink') !== \false) {
            ...
            if (\stripos($this->_agent, 'W3C_Validator') !== \false) {
