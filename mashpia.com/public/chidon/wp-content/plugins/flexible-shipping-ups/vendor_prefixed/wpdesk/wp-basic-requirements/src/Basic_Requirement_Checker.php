...
if (!\interface_exists('UpsFreeVendor\\WPDesk_Requirement_Checker')) {
    require_once 'Requirement_Checker.php';
}
if (!\class_exists('UpsFreeVendor\\WPDesk_Basic_Requirement_Checker')) {
    /**
     * Checks requirements for plugin
     * have to be compatible with PHP 5.3.x
     */
    class WPDesk_Basic_Requirement_Checker implements \UpsFreeVendor\WPDesk_Requirement_Checker
    {
        ...
        {
            return \defined('UpsFreeVendor\\WC_VERSION') && \version_compare(\UpsFreeVendor\WC_VERSION, $min_version, '>=');
        }
        /**
