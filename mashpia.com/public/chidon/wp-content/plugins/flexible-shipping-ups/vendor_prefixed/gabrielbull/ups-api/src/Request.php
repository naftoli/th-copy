...
class Request implements \UpsFreeVendor\Ups\RequestInterface, \Psr\Log\LoggerAwareInterface
{
    /**
     * @var string
     */
            ...
            if ($response->getStatusCode() === 200) {
                ...
                if (isset($xml->Response) && isset($xml->Response->ResponseStatusCode)) {
                    if ($xml->Response->ResponseStatusCode == 1) {
                        ...
                        throw new \UpsFreeVendor\Ups\Exception\InvalidResponseException('Failure: ' . $xml->Response->Error->ErrorDescription . ' (' . $xml->Response->Error->ErrorCode . ')');
                    }
                } else {
