...
use UpsFreeVendor\Ups\Entity\LabelRecoveryRequest;
use UpsFreeVendor\Ups\Entity\LabelRecoveryResponse;
/**
...
class LabelRecovery extends \UpsFreeVendor\Ups\Ups
{
    ...
    private function formatResponse(\SimpleXMLElement $response)
    {
        ...
        return new \UpsFreeVendor\Ups\Entity\LabelRecoveryResponse($result->LabelRecoveryResponse);
    }
}
