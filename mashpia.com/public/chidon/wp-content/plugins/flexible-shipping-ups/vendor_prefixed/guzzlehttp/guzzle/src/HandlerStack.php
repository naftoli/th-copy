...
class HandlerStack
{
    ...
    public static function create(callable $handler = null)
    {
        ...
        $stack->push(\UpsFreeVendor\GuzzleHttp\Middleware::httpErrors(), 'http_errors');
        $stack->push(\UpsFreeVendor\GuzzleHttp\Middleware::redirect(), 'allow_redirects');
        $stack->push(\UpsFreeVendor\GuzzleHttp\Middleware::cookies(), 'cookies');
        $stack->push(\UpsFreeVendor\GuzzleHttp\Middleware::prepareBody(), 'prepare_body');
        return $stack;
    }
    /**
