 ...
 */
class NewRelicHandler extends \UpsFreeVendor\Monolog\Handler\AbstractProcessingHandler
{
    /**
     ...
     */
    public function __construct($level = \UpsFreeVendor\Monolog\Logger::ERROR, $bubble = \true, $appName = null, $explodeArrays = \false, $transactionName = null)
    {
    ...
    protected function write(array $record)
    {
        if (!$this->isNewRelicEnabled()) {
            throw new \UpsFreeVendor\Monolog\Handler\MissingExtensionException('The newrelic PHP extension is required to use the NewRelicHandler');
        }
