 ...
 */
class CubeHandler extends \UpsFreeVendor\Monolog\Handler\AbstractProcessingHandler
{
     ...
     */
    public function __construct($url, $level = \UpsFreeVendor\Monolog\Logger::DEBUG, $bubble = \true)
    {
    ...
    protected function connectUdp()
    {
        if (!\extension_loaded('sockets')) {
            throw new \UpsFreeVendor\Monolog\Handler\MissingExtensionException('The sockets extension is required to use udp URLs with the CubeHandler');
        }
    ...
    private function writeHttp($data)
    {
        ...
        \UpsFreeVendor\Monolog\Handler\Curl\Util::execute($this->httpConnection, 5, \false);
    }
}
