 ...
 */
namespace UpsFreeVendor\Monolog\Handler\Slack;
...
class SlackRecord
{
    ...
    public function __construct($channel = null, $username = null, $useAttachment = \true, $userIcon = null, $useShortAttachment = \false, $includeContextAndExtra = \false, array $excludeFields = array(), \UpsFreeVendor\Monolog\Formatter\FormatterInterface $formatter = null)
    {
        ...
        if ($this->includeContextAndExtra) {
            $this->normalizerFormatter = new \UpsFreeVendor\Monolog\Formatter\NormalizerFormatter();
        }
    }
    ...
    {
        switch (\true) {
            case $level >= \UpsFreeVendor\Monolog\Logger::ERROR:
                return self::COLOR_DANGER;
            case $level >= \UpsFreeVendor\Monolog\Logger::WARNING:
                return self::COLOR_WARNING;
            case $level >= \UpsFreeVendor\Monolog\Logger::INFO:
