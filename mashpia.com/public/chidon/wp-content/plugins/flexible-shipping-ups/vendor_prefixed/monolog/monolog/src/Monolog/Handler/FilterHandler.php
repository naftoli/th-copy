 ...
 */
class FilterHandler extends \UpsFreeVendor\Monolog\Handler\AbstractHandler
{
    /**
     ...
     */
    public function __construct($handler, $minLevelOrList = \UpsFreeVendor\Monolog\Logger::DEBUG, $maxLevel = \UpsFreeVendor\Monolog\Logger::EMERGENCY, $bubble = \true)
    {
     ...
     */
    public function setAcceptedLevels($minLevelOrList = \UpsFreeVendor\Monolog\Logger::DEBUG, $maxLevel = \UpsFreeVendor\Monolog\Logger::EMERGENCY)
    {
