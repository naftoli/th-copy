...
use UpsFreeVendor\Monolog\Formatter\ChromePHPFormatter;
...
class ChromePHPHandler extends \UpsFreeVendor\Monolog\Handler\AbstractProcessingHandler
{
    ...
    protected function send()
    {
        ...
        if (\strlen($data) > 3 * 1024) {
            self::$overflowed = \true;
            $record = array('message' => 'Incomplete logs, chrome header size limit reached', 'context' => array(), 'level' => \UpsFreeVendor\Monolog\Logger::WARNING, 'level_name' => \UpsFreeVendor\Monolog\Logger::getLevelName(\UpsFreeVendor\Monolog\Logger::WARNING), 'channel' => 'monolog', 'datetime' => new \DateTime(), 'extra' => array());
