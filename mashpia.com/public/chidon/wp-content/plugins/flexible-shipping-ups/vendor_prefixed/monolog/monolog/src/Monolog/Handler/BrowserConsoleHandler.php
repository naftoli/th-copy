 ...
 */
class BrowserConsoleHandler extends \UpsFreeVendor\Monolog\Handler\AbstractProcessingHandler
{
    ...
    {
        return new \UpsFreeVendor\Monolog\Formatter\LineFormatter('[[%channel%]]{macro: autolabel} [[%level_name%]]{font-weight: bold} %message%');
    }
    /**
     * {@inheritDoc}
     */
