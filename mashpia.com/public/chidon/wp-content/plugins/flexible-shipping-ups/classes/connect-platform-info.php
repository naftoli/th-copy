 ...
 */
class Flexible_Shipping_UPS_Connect_Platform_Info implements \UpsFreeVendor\WPDesk\PluginBuilder\Plugin\HookablePluginDependant {
	 ...
	 * Show info notice.
	 *
	 * @return null|\UpsFreeVendor\WPDesk\Notice\PermanentDismissibleNotice
	 */
	public function show_info_notice() {
		if ( $this->end_time > current_time( 'timestamp' ) ) {
			...
			return new \UpsFreeVendor\WPDesk\Notice\PermanentDismissibleNotice(
				$notice_content,
