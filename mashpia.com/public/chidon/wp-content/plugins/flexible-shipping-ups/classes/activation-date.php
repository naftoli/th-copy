...
/**
 * Creates plugin activation date.
 */
class Flexible_Shipping_UPS_Activation_Date implements \UpsFreeVendor\WPDesk\PluginBuilder\Plugin\Hookable {
	 ...
	 */
	public function maybe_set_plugin_activation_date() {
