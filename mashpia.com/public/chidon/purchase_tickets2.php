...
if ((empty($_SERVER['HTTPS']) || $_SERVER['HTTPS'] === 'off') || $_SERVER['SERVER_PORT'] != 443) {
    header("Location: https://mashpia.com/chidon/purchase_tickets2.php");
}
require '../db.php';
...
if ($totalTickets >= 1202) {
	$msg = "All tickets have been sold. Please contact Chidon HQ for more info.";
}
...
<div class="content">
	...
	<div class="col-md-9 content-top">
		...
		<div class='tickets'>
			<a name="tickets"></a>
			<form action="purchase_tickets2.php" method="post" id="ticketsForm">
				<fieldset>
