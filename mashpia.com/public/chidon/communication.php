...
<div class="content">
	<div class="col-md-9 content-top">
		<div class="number">
    		...
    		<div class="row_8">
   		        <h3 class="page-in">Communication</h3>					
				
				<p class="page-top">
					To be added to a Chidon Whatsapp Broadcast (where you can receive messages privately (not as part of a group), please email your cell number to chidon@tzivoshashem.org
				</p>
