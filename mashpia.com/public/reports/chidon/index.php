...
<html>
    ...
    <body>
        ...
        <div id="action-links">
            ...
            <a href="/chidonOld/newReports/chidon_user_prizes.php">
                <div class="button">
                    <img src="/images/icon_auction.png" height="32" alt="tickets"/>
                    <span class="link-text">Chidon Prizes Report</span>
                </div>
            </a>
            <a href="/chidonOld/credit_prizes/">
                <div class="button">
                    <img src="/images/icon_auction.png" height="32" alt="tickets"/>
        ...
        <div id="action-links">
            ...
            <a href="anashLabels.php<?=$debug ? "?debug=true": "";?>">
                <div class="button">
                    <img src="/v2/images/back-end/admin/icon_install.png" height="32" alt="tickets"/>
                    <span class="link-text">Labels for Anash Kinder</span>
                </div>
            </a>
        </div>
