...
if (isset($_FILES['file'])) {
    ...
    try {
        ...
        $MASHPIA_DB->commit();
        echo $updated . ' ranks were set as shipped.';

    } catch (Exception $e) {
        $MASHPIA_DB->rollBack();
        echo "Error setting ranks as shipped: " . htmlspecialchars($e->getMessage());
    }
}
...
<html>
<head>
    <title>Upload Ranks Shipped</title>
    <style>
      body {
