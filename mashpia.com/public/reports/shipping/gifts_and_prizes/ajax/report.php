        ...
        <tbody>
            ...
            if ($shipping_status == "all" && $sort == "status") {
                ...
                foreach($schoolsUsers[$school_id] as $user) { // get the shipments for each user....
                    ...
                    if(isset($school_auctions[$user['user_id']])) $tmp = array_merge($tmp, $school_auctions[$user['user_id']]); // add the gifts to the tmp shipments array
                ...
                foreach($schoolsUsers[$school_id] as $user) {
                    ...
                    if(isset($school_auctions[$user['user_id']])) $user_shipments = array_merge($user_shipments, $school_auctions[$user['user_id']]); // merge it with the gifts...
