...
<html>
    <head>
        ...
        <title>Tzivos Hashem | Shipping Reports Home Page</title>
    ...
    <body>
        ...
        ?>
        <h1>Tzivos Hashem Shipping Reports</h1>
        ...
        <div id="action-links">
            ...
            <a href="/medals_labels.php<?=$debug ? "?debug=true": "";?>">
                <div class="button">
                    <img src="/images/icon_report.png" height="32" alt="tickets"/>
                    <span class="link-text">School Campaign Medals Shipping Labels</span>
                </div>
            </a>
            ...
            <a href="/raffle_shipping.php<?=$debug ? "?debug=true": "";?>">
                <div class="button">
                    ...
                    <span class="link-text">5777 Auctions</span>
                </div>
            </a>
        </div>
        <?php endif; ?>
