...
if (isset($_POST['submit'])) {
    ...
    // $defaultEnd = 2460916; // August 28, 2025
...
//                            }
                            if (strpos($val, ',') !== false) {
                                $arrTemp = explode(',', $val);
                                $year = in_array($arrTemp[0], array(12,13)) ? ($missionYear - 1) : $missionYear;
                                $defaultStart = jewishtojd($arrTemp[0], $arrTemp[1], $year);
                            }
                            break;
                        // End Date
                        case 3:
...
//            exit;
    ...
    <div id="task_form">
        <h2>Upload File</h2>
        <form enctype="multipart/form-data" action="create_tasks_ds.php" method="post">
            Choose Campaign: <br />
