...
function update() {
    ...
    $res = $result->execute([':id' => $id, ':start_date' => $start_date, ':end_date' => $end_date, ':sponsor' => $sponsor, ':reason' => $reason, ':name' => $name, ':email' => $email, ':phone' => $phone, ':amount_paid' => $amount_paid]);
