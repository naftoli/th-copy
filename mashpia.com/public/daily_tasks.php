                        ...
                        <div class="marking module">
                            <div class="row top_row">
                                <div class="days">
                                    ...
                                    <div class="cell<?=$special;?>"><?=$days_of_the_week[$dno % 7];?>
                                    	<? if ($label == 'Waking up like a Chayol') : ?>
	                                    	<? if (isset($heDates)) : ?>
	                                    		<span style='font-size: 8px'><br /><?=$heDates[$dno]?></span>
	                                    	<? endif; ?>
	                                    <? endif; ?>
                                    </div>
                                    <? endfor; ?>               
                            ...
                            <div class="row tasks bonus">                   
                                ...
                                <div class="campaign_logo">
                                    <? if ( isset( $daily_task->subject_image_id ) ) { ?>
	                                    <? 
                                    	$img = $daily_task->subject_image_id;
										switch ($img) {
											case '3968888978':
												$img .= ".png";
												break;
										...
										?>
                                    <img alt="" src="/images/stickers/Sticker-<?=$img;?>">
                                    <? } ?>
                                </div>
