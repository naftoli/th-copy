...
<head>
  ...
  <title><?=T_('5776 Setup Guide'), ' - ', T_('Tzivos Hashem Management System')?></title>
...
$(function() {
  ...
  <div id="container">
    <header>
        <h1><?=T_('Tzivos Hashem 5776 - Setup Guide')?></h1>
    </header>
                    ...
                    <div class="module" id="module-alerts">
                        <div class="module_content list_expand numbered">
                            <ul>
                                ...
                                <li>
                                    <h3><span class="icon"></span>Register Students for 5776</h3>
