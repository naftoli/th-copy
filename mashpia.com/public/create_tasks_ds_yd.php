...
?>
    ...
    if (isset($_POST['submit'])) {
        ...
        if (mysql_num_rows($result) > 0) {
            ...
            $missionNumber = ceil($row['mission_number']);
            $missionNumber++;
        } else {
            $missionNumber = 1;
        }
            ...
            if (move_uploaded_file($_FILES['tasks']['tmp_name'], $file)) {
                ...
                foreach ( $objWorksheet->getRowIterator() as $row ) {
                    ...
                    foreach( $cellIterator as $cell ) {
                        ...
                        echo "Field: " . $fieldNames[$i] . " - " . $val . "<br />"; continue;
                        switch ($i) { //$i represents the column in the row
                            ...
                            case 7:
                                $types = explode(',', $val);
                                break;
                            // Mission marking, Grid Marking, Quantity, Daily, Needed and Focus all default to 0 if left blank
                            case 9:
                            case 10:
                            case 11:
                            case 12:
