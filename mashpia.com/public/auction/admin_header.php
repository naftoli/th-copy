		...
		<? 	$url_id = isset($school_id) ? "?school_id=$admin->school_id" : '';
			$url_id2 = $url_id === '' ? '?' : $url_id . '&amp;'; ?>
				...
				<ul class="list_second">
					...
					<li><a href="../admin_user_withdraw.php<?=$url_id?>"><?=T_("Create Soldiers' Vouchers")?></a></li>
...
<!--</li>-->
				...
				<li class="list_parent<?=isset($ui_type) && $ui_type == 'programs' ? ' current' : ''?>">
					<a href="../admin_school_subjects.php<?=$url_id?>" title="programs"><div><span class="icon"><img height="28" width="28" alt="Campaigns" src="images/icon_admin_medal.png"></span><?=T_('Campaigns')?></div></a>
				</li>
...
<!--</li>-->
				...
				<!--****************************************************-->
					...
					<li class="list_parent link">
						<!--<a href="http://mashpia.icorpa.com/login/auto?user_id=<?php echo $admin_user['admin_id']; ?>&institution_id=<?php echo $admin_user['auths']['school'][0]; ?>&full_name=<?php echo $admin_user['display']; ?>&permission=<?php echo $role_name; ?>">-->
						<!--<a href="http://mashpia3.icorpa.com/login/auto?user_id=<?=$admin->admin_id;?>&email=<?=$admin->admin_email;?>&password=<?=MD5($admin->password);?>">-->
						<a href="http://mashpia.icorpa.com/login/auto?user_id=<?=$admin->admin_id;?>&email=<?=$admin->admin_email;?>&password=<?=MD5($admin->password);?>">
							<span class="icon">
...
-->
	<li class="list_parent"><a href="#" title="child"><span class="icon"><img height="28" width="28" alt="Logout" src="images/icon_door.png"></span><?=T_('Child Management')?></a></li>
	<ul class="list_second">
