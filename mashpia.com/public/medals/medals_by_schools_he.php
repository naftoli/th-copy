        ...
        <div class="date-form">
            <form method="POST" class="row g-3 align-items-end">
                <div class="col-md-4">
                    ...
                    <input type="text" class="form-control" id="from" name="from" autocomplete="off" required />
                </div>
                <div class="col-md-4">
                    <label for="to" class="form-label">To Date</label>
                    <input type="text" class="form-control" id="to" name="to" autocomplete="off" required />
                </div>
                <div class="col-md-4">
                    <button type="submit" class="btn btn-primary" onClick="generateReport(event)">Generate Report</button>
