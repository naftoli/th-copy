...
<html>
    ...
    <body>
        ...
        ?>
        <form method="post" action="task_customization2.php">
            ...
            <div class="infobox2 marking_list clearfix" id="filter" style="padding: 10px">
                ...
                <div id="selection" style="padding: 10px;">
                    ...
                    <div style="margin: auto; font-size: 12px; text-align: center">
                    	Tasks Language: 
                    ...
                    <div class="class_list_div select_box">
                        ...
                        <SELECT name="class" id="class">
							...
							foreach ($grades as $grade) {
								...
								if ($_POST['class'] == $grade) echo " selected ";
								echo ">" . $grade . "</option>";
							}
							?>
                        </SELECT>               
                    ...
                    <div class="date_list select_box" style="margin-left: 25% !important">   
                        <!--               
                        <a class="prev button">
                            <span class="icon"></span>
                    ...
                    <div class="dates" style="width: 300px !important; margin-left: 29% !important">                  
                        <INPUT type="hidden" id="start_date" name="start_date" value="<?= isset($start_date) ? $start_date : $dates['start'] ?>">
                        <INPUT class="newListSelected" style="width: 150px !important;" type="text" name="start_date_disp" READONLY value="<?=es(dateToHebrew(isset($start_date) ? $start_date : $dates['start']))?>" onClick="getDate(this.form, 'start_date', true);"/>
                        <INPUT type="hidden" id="end_date" name="end_date" value="<?= isset($end_date) ? $end_date : $dates['end'] ?>">
                        <INPUT class="newListSelected" style="width: 150px !important" type="text" name="end_date_disp" READONLY value="<?=es(dateToHebrew(isset($end_date) ? $end_date : $dates['end']))?>" onClick="getDate(this.form, 'end_date', true);"/>
                    </div>
        ...
        if ((isset($_POST['class']) && $_POST['class'] == -1) && (isset($_POST['submit']) && $_POST['submit'] == 'Go')) { ?>
    ...
    <script type="text/javascript">         
        $( function() {             
            ...
            $("#resetFilter").click( function() {
                window.location = 'task_customization2.php';
            });
                        ...
                        $.getJSON('ajax/getTasks.php', {
                            ...
                            $.each( data, function( cat, info ) {
                                $.each( info, function( enrolled, names ) { 
                                    str += "<div class='listing'><li><input name='tasks[]' type='checkbox' class='task' value=\"" + subject_id + "|" + encodeURI(cat) + "\"";
                                    if ( enrolled && checked ) {
                                        str += ' checked ';
                                    }
                                    ...
                                    if (decodeURI(cat) == 'Learning with Parents') { 
                                    ...
                                    <? if ( isset( $start_date ) ) { ?>
                                        ...
                                        $.getJSON('ajax/getMissions.php', {
                                            ...
                                            $(".checkAll").click( function() { 
                                                ...
                                                input.each( function() {
                                                    var val = decodeURI($(o).find('.task').val()) + '~' + $(this).val();
                                            ...
                                            $(".mission").click( function() { 
                                                ...
                                                if ( checked ) { 
                                                    ...
                                                    if ( !taskChecked ) {
                                                        ...
                                                        updateArray( tasks, checked, decodeURI(task.val()) );
                                                        updateArray( tasksAdded, !checked, decodeURI(task.val()) );
                                                        ...
                                                        if ( !cChecked ) {
                                                            ...
                                                            task = $(this).parent().parent().siblings().find('.task');
                                                            $.each( task, function() { 
                                                                var checked = $(this).is(":checked");
                                                                updateArray( tasks, checked, decodeURI($(this).val()) );
                                                        ...
                                                        mission = $(this).parent().parent().siblings().find('.mission');
                                                        mission.each( function() { 
                                                            var val = decodeURI($(o).find('.task').val()) + '~' + $(this).val();
                                                            var mChecked = $(this).is(":checked");
                                                            updateArray( missions, mChecked, val );
            ...
            $('#save').click( function() { 
                ...
                if (save) {
                	alert("Please wait until there is a confimation popup saying \"Saved.\"\nTHIS MAY TAKE SOME TIME. THANKS FOR YOUR PATIENCE.");
