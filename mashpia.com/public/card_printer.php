...
<TR>
<TD style="width: 33%;">
  <DIV class="circle">' . $left_circle . '</DIV><div align="center">
  ' . es($description) . '</div>
</TD>
<TH>' . (!is_null($subject_image_id) ? linkImgFile($subject_image_id) : '') . '</TH>
<TD style="width: 33%;">
  <DIV class="circle">' . $right_circle . '</DIV><div align="center">
  ' . es($subject_name) . ($series !== '' && !is_null($series) ? " #$series" : '') . '</div>
</TD>
</TR>
</TABLE>
<DIV class="barcode"><IMG SRC="barcode.php/' . $id . '" alt=""><BR>' . $id . '</DIV>
<DIV class="points"><TABLE><TR><TD><DIV class="border">' . floatval($points) . ' ' . T_('Miles') . $bonus . '</DIV></TD></TR></TABLE></DIV>
</DIV>
</DIV>
';
}
