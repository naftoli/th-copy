...
$chap_query = mysql_query(
     " SELECT th_chidon_chap_id AS chap_id, school_id, chap_type, chidon_type, first_name, last_name, phone, email, dob, sweater_size, "
    ." acc_name, acc_address, acc_cross_st, acc_phone, vehicle, is_walking "
