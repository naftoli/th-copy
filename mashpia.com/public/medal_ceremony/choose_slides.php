    ...
    <body>
        <form method="post" action="slides.php">
            ...
            <fieldset>
                ...
                <input type="radio" name="type" value="3" checked /> Show all medals earned but show old medals as greyed out<br /><br />
                <input type="checkbox" name="currentOnly" value="1" checked /> Only show children that earned at least one medal this period
            </fieldset>
            <br />
            <div align="center">
